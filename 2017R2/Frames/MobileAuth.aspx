...
<body>
    <form id="form1" runat="server" class="background">
        <div class="content">
            ...
            <br />
            <asp:Label ID="lblFail" runat="server" Font-Size="Medium" Font-Bold="True" Visible="false"
                Text="Authentication failed."></asp:Label>
            <asp:Label ID="lblSuccess" runat="server" Font-Size="Medium" Font-Bold="True" Visible="false"
                Text="You have succesfully authenticated."></asp:Label>
        </div>
    </form>
</body>
</html>
