...
public partial class Frames_ProjectBrowser : PXPage
{
	...
	private static readonly string[] _projectMenu = new string[]
	{
		"Screens|~/Pages/AU/AU201000.aspx",
		"Workflows|~/Pages/AU/AU202000.aspx",
		"Data Access|~/Pages/AU/AU203000.aspx",
		"Code|~/Pages/AU/AU204000.aspx",
		"Assemblies|~/Pages/AU/AU205000.aspx",
		"Generic Inquiries|~/Pages/AU/AU206000.aspx",
		"Reports|~/Pages/AU/AU207000.aspx",
		"Site map|~/Pages/AU/AU208000.aspx"
	};

	private static readonly string[] _screenMenu = new string[]
	{
		"Conditions|~/Pages/AU/AU201010.aspx",
		"Actions|~/Pages/AU/AU201020.aspx",
		"Related Reports|~/Pages/AU/AU201030.aspx",
		"Related Screens|~/Pages/AU/AU201040.aspx",
		"Fields Override|~/Pages/AU/AU201050.aspx",
		"Layout|~/Pages/AU/AU201060.aspx"
	};
	
	private static readonly string[] _dacMenu = new string[]
	{
		"Conditions|~/Pages/AP/AP301000.aspx",
		"Actions|~/Pages/AP/AP303000.aspx"
	};
