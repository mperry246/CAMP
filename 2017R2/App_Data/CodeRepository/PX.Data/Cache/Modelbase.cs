...
namespace PX.Data
{
	...
	public abstract partial class PXCache
	{
        ...
        /// <summary>Clones the field values.</summary>
...
#pragma warning restore 618
	...
	public static class PXCacheEx
	{
		...
		public struct AttributeAdjuster<TAttribute>
			where TAttribute : PXEventSubscriberAttribute
		{
			...
			public AttributeAdjuster<TAttribute> By([NotNull] Action<TAttribute> adjustment)
			{
			...
			public struct Chained
			{
				...
				/// </summary>
				/// <param name="adjustment">An attribute adjustment action</param>
				public AttributeAdjuster<TAttribute> By([NotNull] Action<TAttribute> adjustment) => _previousAdjuster.By(adjustment);
