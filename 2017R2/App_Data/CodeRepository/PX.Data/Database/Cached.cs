...
//			IBqlParameter[] selpars = _Select.GetParameters();
		...
		/// <summary>Allows to get or set the values indicating user's choice in the dialog
		/// window displayed through one of the <tt>Ask()</tt> methods.</summary>
		public AnswerIndexer Answers => new AnswerIndexer(this);
		public struct AnswerIndexer
		{
