...
namespace PX.Objects.CA
{
	...
	public class CADepositEntry : PXGraph<CADepositEntry, CADeposit>
	{
		...
		{
			#region DocType
			public abstract new class docType : PX.Data.IBqlField
			{
			}
			#endregion
			#region RefNbr
			public abstract new class refNbr : PX.Data.IBqlField
			{
			}			
			#endregion
			#region DepositDate
			public abstract new class depositDate : PX.Data.IBqlField
			{
			}
			#endregion
			#region DepositType
			public abstract new class depositType : PX.Data.IBqlField
			{
			}			
			#endregion
			#region DepositNbr
			public abstract new class depositNbr : PX.Data.IBqlField
			{
			}			
			#endregion
			#region Deposited
			public abstract new class deposited : PX.Data.IBqlField
			{
			}			
			#endregion			
			#region Methods
		...
		public virtual IEnumerable availablePayments()
		{
...

			{
				PXSelectBase<Light.APPayment> apPaymentSelect = new PXSelectJoin<Light.APPayment,
									...
									Where<CashAccountDeposit.accountID, Equal<Current<CADeposit.cashAccountID>>,
									And<Light.APPayment.docType, Equal<APDocType.refund>,
