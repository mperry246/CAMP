...
namespace PX.Objects.CA
{
	...
	public class DepositTranIDAttribute : CashTranIDAttribute
	{
		...
		{
			if (((parentDoc.Released == true) && (catran_Row.TranID != null)) || parentDoc.CuryTranAmt == 0m)
			{
				return null;
			}
	...
	public abstract class CashTranIDAttribute : PXEventSubscriberAttribute, IPXRowPersistingSubscriber, IPXRowPersistedSubscriber, IPXRowDeletedSubscriber
	{
		...
		public virtual Type IsMigrationModeEnabledSetupField
		{
			get;
			set;
		}
		...
		public CashTranIDAttribute(Type isMigrationModeEnabledSetupField)
			: base()
		{
			IsMigrationModeEnabledSetupField = isMigrationModeEnabledSetupField;
		}
		...
		{
			if (IsMigrationModeEnabled == true) return;
