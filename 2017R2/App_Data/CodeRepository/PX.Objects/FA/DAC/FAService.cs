...
namespace PX.Objects.FA
{
	...
	public partial class FAService : PX.Data.IBqlTable
	{
		...
		public abstract class serviceNumber : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region ServiceDate
		public abstract class serviceDate : PX.Data.IBqlField
		{
		}
		...
		public abstract class scheduledDate : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region PerfomedBy
		public abstract class perfomedBy : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region InspectedBy
		public abstract class inspectedBy : PX.Data.IBqlField
		{
		}
		protected Guid? _InspectedBy;
		[PXDBField()]
		// TODO: Defaulting from current custodian (FALocationHistory.custodian)
		//[PXDefault(typeof(FADetails.custodian))]
		[PXSelector(typeof(EPEmployee.userID), SubstituteKey = typeof(EPEmployee.acctCD), DescriptionField = typeof(EPEmployee.acctName))]
		...
		public abstract class serviceAmount : PX.Data.IBqlField
		{
		}
