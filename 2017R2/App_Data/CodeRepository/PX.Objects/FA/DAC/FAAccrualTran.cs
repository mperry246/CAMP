...
namespace PX.Objects.FA
{
	...
	public partial class FAAccrualTran : IBqlTable, IFALocation
	{
        ...
        [PXDimensionSelectorAttribute(BranchAttribute._DimensionName, typeof(Search2<Branch.branchID, LeftJoin<Ledger, On<Ledger.defBranchID, Equal<Branch.branchID>>>, Where2<MatchWithBranch<Branch.branchID>, And<Ledger.ledgerID, IsNull>>>), typeof(Branch.branchCD), ValidComboRequired = true, DescriptionField = typeof(Branch.acctName))]
        ...
        [PXSelector(typeof(Search<BAccountR.bAccountID, Where<BAccountR.type, NotEqual<BAccountType.companyType>,
            And<BAccountR.type, NotEqual<BAccountType.prospectType>>>>), SubstituteKey = typeof(BAccountR.acctCD), CacheGlobal = true)]
