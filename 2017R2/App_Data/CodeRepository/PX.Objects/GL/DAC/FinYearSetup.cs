namespace PX.Objects.GL
{
    ...
    /// <summary>
    /// Represents the Financial Year setup record used to define the template for the actual <see cref="FinYear">Financial Years</see>.
	...
	public partial class FinYearSetup : PX.Data.IBqlTable, IYearSetup
	{
        ...
        /// <summary>
        /// Obsolete field.
        /// The length of <see cref="FinPeriod">periods</see> of the year in days.
        /// </summary>
        ...
        /// <summary>
        /// The read-only field indicating whether the <see cref="FinPeriod">periods</see> of the year can be modified by user.
        /// </summary>
        /// <value>
        ...
        /// See also the <see cref="FinPeriod.IsAdjustment"/> field.
        /// </summary>
		[PXDBBool()]
		[PXDefault(false)]
        ...
        /// <summary>
        /// When <c>true</c>, indicates that the length of the <see cref="FinPeriod">periods</see> of the year in days is fixed.
        /// Read-only field.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Internal type of <see cref="FinPeriod">periods</see> of the year.
        /// Read-only field.
        /// </summary>
        /// <value>
        /// The value of this field is determined by the <see cref="PeriodType"/> field.
