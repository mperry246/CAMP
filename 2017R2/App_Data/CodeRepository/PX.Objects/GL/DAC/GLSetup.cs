namespace PX.Objects.GL
{
    ...
    public partial class GLSetup : PX.Data.IBqlTable
	{
		...
		public abstract class requireRefNbrForTaxEntry : PX.Data.IBqlField
		{
		}
        ...
        /// <summary>
        /// Determines whether the system allows to post transactions to closed <see cref="FinPeriod">Financial Periods</see>.
        ...
        public abstract class reuseRefNbrsInVouchers : IBqlField { }
		...
		public abstract class roundingLimit : IBqlField { }
		...
		public abstract class autoReleaseReclassBatch : PX.Data.IBqlField
		{
		}
