...
namespace PX.Objects.PO
{
	...
	public static class POLineType
	{
	    ...
	    public class goodsForManufacturing : Constant<string>
	    {
	        public goodsForManufacturing() : base(GoodsForManufacturing) {; }
	    }

	    public class nonStockForManufacturing : Constant<string>
	    {
        ...
        public static bool IsStock(string lineType)
		{
			return
		        ...
		        lineType == POLineType.GoodsForManufacturing;
		}
		...
		public static bool IsNonStock(string lineType)
		{
			return
			    ...
			    lineType == POLineType.NonStockForManufacturing;
		}
