...
namespace PX.Objects.AR
{
	...
	public class ARSetupApproval : IBqlTable, IAssignedMap
	{
		...
		[PXSelector(typeof(Search<EPAssignmentMap.assignmentMapID,
				Where2<Where<Current<ARSetupApproval.docType>, Equal<ARDocType.refund>,
						And<EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeARPayment>>>,
					Or<Where<Current<ARSetupApproval.docType>, Equal<ARDocType.cashReturn>,
						And<EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeARCashSale>>>>>>),
