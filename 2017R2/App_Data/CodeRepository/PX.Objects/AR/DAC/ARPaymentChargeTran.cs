...
namespace PX.Objects.AR
{
	...
	public class ARPaymentChargeTran : AP.IPaymentCharge, PX.Data.IBqlTable
	{
		...
		[Account(DisplayName = "Offset Account",Required=true)]
		...
		[PXDBDate()]
		[PXDBDefault(typeof(ARPayment.docDate))]
		...
		[PXDBDefault(typeof(ARPayment.finPeriodID))]
		...
		[PXDBString(6, IsFixed = true)]
		[PXDBDefault(typeof(ARPayment.tranPeriodID))]
		...
		[PXDBLong()]
		[ARPaymentChargeCashTranID(typeof(ARSetup.migrationMode))]
