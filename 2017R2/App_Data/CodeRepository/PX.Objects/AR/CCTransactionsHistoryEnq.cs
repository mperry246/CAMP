...
namespace PX.Objects.AR
{
	...
	public class CCTransactionsHistoryEnq: PXGraph<CCTransactionsHistoryEnq>
	{
		...
		public partial class CCTransactionsHistoryFilter : IBqlTable
		{
			...
			public abstract class cardSearchType : PX.Data.IBqlField
			{
			}
			...
			public abstract class partialCardNumber : PX.Data.IBqlField
			{
			}
			...
			#endregion
			#region NameOnCard
			public abstract class nameOnCard : PX.Data.IBqlField
			{
			}
			...
			public abstract class endDatePlusOne : PX.Data.IBqlField
			{
			}
			[PXDBDate()]
			...
			public abstract class maskedCardNumber : PX.Data.IBqlField
			{
			}
			...
			public abstract class numberOfCards : PX.Data.IBqlField
			{
			}
			...
			#endregion
			#region DBSearchName
			public abstract class dBSearchName: PX.Data.IBqlField
			{
			}
			[PXDBString(255)]
		...
		public virtual IEnumerable viewDocument(PXAdapter adapter)
		{
			...
			if (tran != null)
			{
				PXGraph target = FindSourceDocumentGraph(tran);
				if(target!= null)
