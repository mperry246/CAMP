...
namespace PX.Objects.AR
{
	...
	public class ARFinChargesApplyMaint : PXGraph<ARFinChargesApplyMaint>
	{
		...
		public partial class ARFinChargesApplyParameters : IBqlTable
		{
			...
			public abstract class statementCycle : IBqlField
			{
			}
			...
			public abstract class finChargeDate : IBqlField
			{
			}
			[PXDate]
		...
		public partial class ARFinChargesDetails : IBqlTable
		{
			...
			public abstract class lastPaymentDate : IBqlField
			{
			}
			[PXDate]
			...
			public abstract class lastChargeDate : IBqlField
			{
			}
			[PXDate]
			...
			#endregion
			#region OverdueDays
			public abstract class overdueDays : IBqlField
			{
			}
			[PXShort]
			[PXDefault((short)0)]
			...
			public abstract class finChargeCuryID : IBqlField
			{
			}
			[PXString(5, IsUnicode = true, InputMask = ">LLLLL")]
			...
			#endregion
			#region FinChargeAmt
			public abstract class finChargeAmt : IBqlField
			{
			}
			...
			#endregion
			#region ARAccountID
			public abstract class aRAccountID : IBqlField
			{
			}
			[PXDefault]
			...
			#endregion
			#region CuryMultDiv
			public abstract class curyMultDiv : IBqlField
			{
			}
			...
			public abstract class sampleCuryRate : IBqlField
			{
			}
			[PXDBDecimal(6)]
			...
			public abstract class hasUnreleasedCharges : IBqlField
			{
			}
			[PXDBBool]
			...
			public abstract class lastFCDocType : IBqlField
			{
			}
			...
			#endregion
			#region LastFCRefNbr
			public abstract class lastFCRefNbr : IBqlField
			{
			}
			...
			public abstract class customerHasOpenPayments : IBqlField { }
			[PXBool]
			[PXDefault(false, PersistingCheck = PXPersistingCheck.Nothing)]
