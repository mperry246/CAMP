...
namespace PX.Objects.AR
{
	...
	public static class Messages
	{
		...
		public const string UnprocessedPPDExists = "The report cannot be generated. There are documents with unprocessed cash discounts. To proceed, process these documents by generating and releasing credit memos on the Generate VAT Credit Memos (AR.50.45.00) form.";
