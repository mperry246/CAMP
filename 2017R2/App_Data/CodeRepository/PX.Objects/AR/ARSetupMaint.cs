    ...
    public class ARSetupMaint : PXGraph<ARSetupMaint>
    {
		...
		protected virtual void ARSetup_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			if (row != null)
			{
				...
				PXUIFieldAttribute.SetVisible<ARSetup.applyQuantityDiscountBy>(sender, row, PXAccess.FeatureInstalled<FeaturesSet.vendorDiscounts>() && PXAccess.FeatureInstalled<FeaturesSet.multipleUnitMeasure>());
