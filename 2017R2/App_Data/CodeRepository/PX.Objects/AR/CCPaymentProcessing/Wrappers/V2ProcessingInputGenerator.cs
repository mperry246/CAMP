...
namespace PX.Objects.AR.CCPaymentProcessing.Wrappers
{
	public class V2ProcessingInputGenerator
	{
		...
		private void FillDocumentData(V2.ProcessingInput processingInput, V1.ProcessingInput inputData)
		{
			processingInput.DocumentData = new V2.DocumentData();
			processingInput.DocumentData.DocType = inputData.DocType;
			processingInput.DocumentData.DocRefNbr = inputData.DocRefNbr;
