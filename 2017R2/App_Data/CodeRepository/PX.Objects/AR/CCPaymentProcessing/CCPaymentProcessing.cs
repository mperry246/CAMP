...
namespace PX.Objects.AR.CCPaymentProcessing
{
	public class CCPaymentProcessing
	{
			...
			Func<object, CCProcessingContext, ICardTransactionProcessingWrapper> processingWrapper)
		{
			...
			_processingWrapper = processingWrapper;
		}
		...
		private Func<object, CCProcessingContext, ICardTransactionProcessingWrapper> _processingWrapper;
		...
		public virtual bool RecordAuthorization(ICCPayment aPmtInfo, string aExtTranRef, Decimal? aAuthAmount, DateTime? aExpirationDate, ref int? aTranNbr)
		{
			...
			CCProcTran tran = new CCProcTran
			{
				...
				Amount = aAuthAmount ?? aPmtInfo.CuryDocBal,
