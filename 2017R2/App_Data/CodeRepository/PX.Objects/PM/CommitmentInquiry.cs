	...
	public class CommitmentInquiry : PXGraph<CommitmentInquiry>
	{
		...
		public virtual IEnumerable ViewProject(PXAdapter adapter)
		{
			if (Items.Current != null)
			{
				...
				graph.Project.Current = graph.Project.Search<PMProject.contractID>(Items.Current.ProjectID);
		...
		public partial class ProjectBalanceFilter : IBqlTable
		{
			...
			[Project(typeof(Where<PMProject.nonProject, Equal<False>, And<PMProject.isTemplate, Equal<False>>>))]
