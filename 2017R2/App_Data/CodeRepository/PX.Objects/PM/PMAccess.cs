...
namespace PX.Objects.PM
{
	...
	{
		#region Select
		public PXSelect<PMProject, Where<PMProject.baseType, Equal<PMProject.ProjectBaseType>, And<PMProject.isTemplate, NotEqual<True>>>> Project;
		...
		[PXDimensionSelector(ProjectAttribute.DimensionName,
			typeof(Search<PMProject.contractCD, Where<PMProject.baseType, Equal<PMProject.ProjectBaseType>, And<PMProject.isTemplate, NotEqual<True>, And<Match<Current<AccessInfo.userName>>>>>>),
