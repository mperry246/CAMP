...
namespace PX.Objects.PM
{
	...
	public class ProjectAttribute : AcctSubAttribute, IPXFieldVerifyingSubscriber
	{
		...
		public static bool IsPMVisible(string module)
		{
			...
			ProjectSettingsManager psm = new ProjectSettingsManager();
		...
		public ActiveProjectOrContractBaseAttribute(Type customerField)
		{
			...
			if (PXAccess.FeatureInstalled<FeaturesSet.projectModule>() && customerField != null)
			{
				...
				, typeof(PMProject.contractCD), typeof(PMProject.contractCD), typeof(PMProject.description),
				 typeof(PMProject.status), typeof(PMProject.customerID), typeof(Customer.acctName));
			}
			else
			{
				select = new PXDimensionSelectorAttribute(ProjectAttribute.DimensionName,
			...
			else
			{
				...
				command.AddRange(
					new[]
					{
						...
						typeof(PMProject.baseType),
						typeof(Equal<>),
						typeof(PMProject.ProjectBaseType),
						typeof (And2<,>),
						typeof (Where2<,>),
						typeof (Where<,,>),
						typeof (PMProject.customerID),
	...
	public class ActiveProjectOrContractForGLAttribute : ActiveProjectOrContractBaseAttribute
	{
		...
		public override void FieldVerifying(PXCache sender, PXFieldVerifyingEventArgs e)
		{
			...
			if (project != null && project.NonProject != true)
			{
				if (project.BaseType == PMProject.ProjectBaseType.Project)
				{
					if (project != null && project.NonProject != true && project.BaseType == PMProject.ProjectBaseType.Project &&
	...
	public class EPTimeCardProjectAttribute : AcctSubAttribute
	{
		public EPTimeCardProjectAttribute()
		{
			...
			LeftJoin<BAccount, On<BAccount.bAccountID, Equal<PMProject.customerID>>,
			...
			PXDimensionSelectorAttribute select = new PXDimensionSelectorAttribute(ProjectAttribute.DimensionName, searchType, typeof(PMProject.contractCD),
			typeof(PMProject.contractCD), typeof(PMProject.description), typeof(PMProject.customerID), typeof(BAccount.acctName), typeof(PMProject.locationID), 
			typeof(PMProject.status), typeof(PMProject.approverID), typeof(PMProject.startDate), typeof(ContractBillingSchedule.lastDate), typeof(ContractBillingSchedule.nextDate));
			select.DescriptionField = typeof(PMProject.description);
			select.ValidComboRequired = true;
	...
	public class ProjectTaskAttribute : AcctSubAttribute, IPXRowPersistingSubscriber, IPXFieldSelectingSubscriber
	{
		...
		public virtual void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
		{
			...
			if (ss != null && !AlwaysEnabled)
			{
                ...
                ss.Enabled = (project != null && project.BaseType == PMProject.ProjectBaseType.Project && project.NonProject != true && sender.GetValue(e.Row, projectIDField.Name) != null) || sender.Graph.IsImport;
			}
    ...
    public class BaseProjectTaskAttribute : AcctSubAttribute, IPXFieldSelectingSubscriber, IPXFieldVerifyingSubscriber
	{
		...
		public virtual void RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
		{
			if (e.Operation != PXDBOperation.Delete)
			{
				...
				if (project != null && project.NonProject != true && taskID == null && project.BaseType == PMProject.ProjectBaseType.Project && (needsTaskValidation == true))
				{
					if (sender.RaiseExceptionHandling(FieldName, e.Row, null, new PXSetPropertyException(Data.ErrorMessages.FieldIsEmpty, FieldName)))
					{
						throw new PXRowPersistingException(FieldName, null, Data.ErrorMessages.FieldIsEmpty, FieldName);
		...
		public virtual void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
		{
            ...
            if (ss != null  )
            {
				...
				if (e.Row != null)
				{
					...
					if (this.NeedTaskValidationField != null)
						needsTaskValidation = (Boolean?)sender.GetValue(e.Row, this.NeedTaskValidationField.Name);
					ss.Enabled = (needsTaskValidation == true) && rec != null && rec.NonProject != true && rec.BaseType == PMProject.ProjectBaseType.Project;
				}				
            }
		}
		#endregion
	...
	public class PXTaskIsCompletedException : PXSetPropertyException
	{
		...
		public PXTaskIsCompletedException(int? taskID):base(PM.Messages.ProjectTaskIsCompleted)
		{
			this.TaskID = taskID;
		}
	...
	public class EPBaseAllowProjectTaskAttribute : AcctSubAttribute
	{
		...
		public Type SkipValidationField { get; set; }
		...
		public virtual void RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
		{
			...
			if (contract != null && contract.NonProject != true && taskID == null && contract.BaseType == PMProject.ProjectBaseType.Project)
			{
				if (sender.RaiseExceptionHandling(FieldName, e.Row, null, new PXSetPropertyException(Data.ErrorMessages.FieldIsEmpty, FieldName)))
				{
					throw new PXRowPersistingException(FieldName, null, Data.ErrorMessages.FieldIsEmpty, FieldName);
		...
		public virtual void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
		{
			...
			if (ss != null)
			{
				...
				if (e.Row != null)
				{
					...
					ss.Enabled = rec != null && rec.NonProject != true && rec.BaseType == PMProject.ProjectBaseType.Project;
				}
			}
		}
		#endregion
	...
	public class ProjectDefaultAttribute : PXDefaultAttribute
	{
		...
		public static bool IsProject(PXGraph graph, int? projectID)
		{
			...
			if (rec.BaseType != PMProject.ProjectBaseType.Project)
				return false;
	...
	public class PMInventorySelectorAttribute : PXSelectorAttribute
    {
        public PMInventorySelectorAttribute()
			:base(typeof(Search<InventoryItem.inventoryID, Where<InventoryItem.itemStatus, Equal<InventoryItemStatus.unknown>,
				Or<Match<Current<AccessInfo.userName>>>>>))
		{
			SubstituteKey = typeof(InventoryItem.inventoryCD);
			Filterable = true;
		}

		public bool SuppressFieldVerifyingIfCostCodeIsOn { get; set; }
    ...
    public class PMDetailAccumAttribute : PXAccumulatorAttribute
    {
        public PMDetailAccumAttribute()
        {
            base._SingleRecord = true;
        }
        protected override bool PrepareInsert(PXCache sender, object row, PXAccumulatorCollection columns)
        {
            ...
            PMDetailAcum item = (PMDetailAcum)row;
            columns.Update<PMDetailAcum.used>(item.Used, PXDataFieldAssign.AssignBehavior.Summarize);
            columns.Update<PMDetailAcum.usedTotal>(item.UsedTotal, PXDataFieldAssign.AssignBehavior.Summarize);

            //columns.Update<PMDetailAcum.contractID>(item.ContractID, PXDataFieldAssign.AssignBehavior.Initialize);
            //columns.Update<PMDetailAcum.inventoryID>(item.InventoryID, PXDataFieldAssign.AssignBehavior.Initialize);
	...
	#region projectType
	[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
	public sealed class projectType : Constant<string>
	{
		public projectType()
	...
	public class CostCodeAttribute : AcctSubAttribute, IPXRowPersistingSubscriber
	{
		...
		public CostCodeAttribute(Type account, Type task, Type WhereType)
		{
			this.task = task;
			this.account = account;

			Type SearchType = typeof(Search<PMCostCode.costCodeID>);
			...
			if (account != null && task != null)
			{
				SearchType =
					...
					typeof(Current<>),
					task,
					typeof(And<PMBudget.costCodeID, Equal<PMCostCode.costCodeID>>),
					...
					typeof(Current<>),
					account,
					typeof(And<PMBudget.accountGroupID, Equal<Account.accountGroupID>>),
					...
					typeof(Aggregate<GroupBy<PMCostCode.costCodeID>>)
					);
			...
			if (account == null && task != null)
			{
				//Dispaly only cost codes from Cost Budget.
				SearchType =
					BqlCommand.Compose(
					typeof(Search5<,,,>),
					typeof(PMCostCode.costCodeID),
					...
					typeof(Current<>),
					task,
					typeof(And<PMBudget.costCodeID, Equal<PMCostCode.costCodeID>, And<PMBudget.type, Equal<GL.AccountType.expense>>>),
			...
			PXDimensionSelectorAttribute select = new PXDimensionSelectorAttribute(COSTCODE, SearchType, typeof(PMCostCode.costCodeCD));
			select.DescriptionField = typeof(PMCostCode.description);
