...
using System.Collections.Generic;
	...
	[PXCacheName(Messages.PMAllocationStep)]
	...
	public partial class PMAllocationStep : PX.Data.IBqlTable
	{
		...
		[PXDBString(1)]
		[PXUIField(DisplayName = "Transaction Branch", FieldClass = "BRANCH")]
		...
		#endregion
		#region FullDetail
		public abstract class fullDetail : PX.Data.IBqlField
		{
		}
		...
		public abstract class markAsNotAllocated : PX.Data.IBqlField
		{
		}
	...
	public static class PMReverse
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute() : base(
				new[]
				{
					Pair(OnInvoice, Messages.PMReverse_OnInvoice),
					Pair(OnBilling, Messages.PMReverse_OnBilling),
		...
		public class onInvoice : Constant<string>
		{
			public onInvoice() : base(OnInvoice) {; }
		}
