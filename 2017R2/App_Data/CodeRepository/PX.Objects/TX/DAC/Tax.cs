...
namespace PX.Objects.TX
{
	...
	public static class CSTaxCalcType
	{
		...
		public class doc : Constant<string>
		{
			public doc() : base(Doc) { }
		}
	}
	...
	public static class CSTaxTermsDiscount
	{
		...
		public class toPromtPayment : Constant<string>
		{
	...
	public partial class Tax : PX.Data.IBqlTable
	{
		...
		/// <summary>
		/// Specifies (if set to <c>true</c>) that the system should exclude the first-level tax amount from the tax base
		/// that is used for calculation of the second-level tax amount. The flag is applicable to only first-level taxes.
		/// </summary>
		[PXDBBool()]
		[PXDefault(false)]
		...
		public abstract class includeInTaxable : PX.Data.IBqlField
		{
		}
		...
		public abstract class reportExpenseToSingleAccount : PX.Data.IBqlField
		{
		}
		...
		/// <summary>
		/// Specifies (if set to <c>true</c>) that the tax zone is used for the external tax provider (Avalara).
		/// </summary>
		[PXDBBool()]
		[PXDefault(false)]
