...
namespace PX.Objects.TX
{
	public abstract class ManualVATAttribute : TaxAttribute
	{
		...
		public ManualVATAttribute(Type ParentType, Type TaxType, Type TaxSumType)
            :base(ParentType, TaxType, TaxSumType)
		{
		}

		public ManualVATAttribute(Type ParentType, Type TaxType, Type TaxSumType, Type CalcMode)
