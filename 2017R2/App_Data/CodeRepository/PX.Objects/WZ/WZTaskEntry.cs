...
namespace PX.Objects.WZ
{
    public class WZTaskEntry : PXGraph<WZTaskEntry>
    {
        ...
        protected virtual void WZTask_RowInserted(PXCache sender, PXRowInsertedEventArgs e)
        {
            ...
            TasksTreeItems.Cache.ClearQueryCache();
        ...
        public virtual IEnumerable ActivateScenario(PXAdapter adapter)
        {
            ...
            if (scenario != null && scenario.Status != WizardScenarioStatusesAttribute._ACTIVE)
            {
                prepareTasksForActivation.Press();
                activateScenarioWithoutRefresh.Press();
                PXSiteMap.Provider.Clear();
        ...
        public virtual IEnumerable CompleteScenario(PXAdapter adapter)
        {
            ...
            if (scenario != null && scenario.Status == WizardScenarioStatusesAttribute._ACTIVE)
            {
                completeScenarioWithoutRefresh.Press();
				throw new PXRefreshException();
			}
            return adapter.Get();
        }
        ...
        public virtual IEnumerable Up(PXAdapter adapter)
        {
            ...
            TaskInfo.Cache.ClearQueryCache();
            TasksTreeItems.Cache.ClearQueryCache();
            TasksTreeItems.View.RequestRefresh();
            return adapter.Get();
        }
    ...
    {
        #region ScenarioID
        public new abstract class scenarioID : IBqlField { }
        ...
        public new abstract class predecessorID : IBqlField { }
        [PXDBGuid(IsKey = true)]
