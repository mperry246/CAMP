...
namespace PX.Objects.AP
{
	...
	public class APPendingInvoicesEnq : PXGraph<APPendingInvoicesEnq>
	{
		...
		public partial class PendingPaymentSummary: IBqlTable
		{
			...
			public abstract class validDiscCount : PX.Data.IBqlField
			{
			}
			...
			#endregion
			#region ValidDiscBal
			public abstract class validDiscBal : PX.Data.IBqlField
			{
			}
			...
			public abstract class validCuryDiscBal : PX.Data.IBqlField
			{
			}
			...
			public abstract class lostDiscCount : PX.Data.IBqlField
			{
			}
			...
			#endregion
			#region LostDiscBal
			public abstract class lostDiscBal : PX.Data.IBqlField
			{
			}
			...
			public abstract class lostCuryDiscBal : PX.Data.IBqlField
			{
			}
