    ...
    public class APPriceWorksheetMaint : PXGraph<APPriceWorksheetMaint, APPriceWorksheet>
    {
        ...
        public static void ReleaseWorksheet(APPriceWorksheet priceWorksheet)
        {
            ...
            using (PXTransactionScope ts = new PXTransactionScope())
            {
                ...
                {
                    vendorPriceWorksheetMaint.CreateVendorPricesOnWorksheetRelease(row);
                }
        ...
        protected virtual void CreateVendorPricesOnWorksheetRelease(PXResult<APPriceWorksheetDetail, InventoryItem> row)
        {
            ...
            PXResultset<APVendorPrice> salesPrices = GetVendorPricesByPriceLineForWorksheetRelease(priceLine);
        ...
        public virtual IEnumerable AddSelItems(PXAdapter adapter)
        {
            ...
            foreach (ARAddItemSelected line in addItemLookup.Cache.Cached)
            {
                ...
                PXResultset<APVendorPrice> salesPrices =
                   ...
                   .SelectMultiBound(this, currents, priceCode, line.InventoryID, addItemParameters.Current.CuryID);
