...
namespace PX.Objects.CM
{
    ...
    public partial class TranslationEnqFilter : PX.Data.IBqlTable
    {
        ...
        #endregion
        #region Unreleased
        public abstract class unreleased : IBqlField
        {
        }
    ...
    public class TranslationUnReleased : Constant<string>
    {
        public TranslationUnReleased() : base("U") { ;}
    }

    public class TranslationReleased : Constant<string>
    {
        public TranslationReleased() : base("R") { ;}
    }

    public class TranslationVoided : Constant<string>
    {
