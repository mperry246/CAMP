...
namespace PX.Objects.SO
{
	...
	public class SOCreate : PXGraph<SOCreate>
	{
		...
		public PXFilteredProcessingJoin<SOFixedDemand, SOCreateFilter,
			...
			And<Where<INItemClass.itemClassCD, Like<Current<SOCreateFilter.itemClassCDWildcard>>, Or<Current<SOCreateFilter.itemClassCDWildcard>, IsNull>>>>>>>>>> FixedDemand;
		...
		public partial class SOFixedDemand : INItemPlan
		{
			...
			#endregion
            #region DemandSiteID
            public abstract class demandSiteID : PX.Data.IBqlField
            {
            }
