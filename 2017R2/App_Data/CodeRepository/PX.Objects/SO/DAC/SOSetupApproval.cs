    ...
    public partial class SOSetupApproval : PX.Data.IBqlTable, IAssignedMap
    {
        ...
        public class ApprovableOrderTypeSelectorAttribute : PXCustomSelectorAttribute
        {
            ...
            public ApprovableOrderTypeSelectorAttribute()
                : base(typeof(Search2<SOOrderType.orderType, InnerJoin<SOOrderTypeOperation, On<SOOrderTypeOperation.orderType, Equal<SOOrderType.orderType>, And<SOOrderTypeOperation.operation, Equal<SOOrderType.defaultOperation>>>>>))
            {
            }
        ...
        #endregion
        #region NonExistence
        public abstract class nonExistence : PX.Data.IBqlField
        {
        }
