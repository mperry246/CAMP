namespace PX.Objects.SO
{
	...
	public partial class SOInvoiceDiscountDetail : PX.Data.IBqlTable, IDiscountDetail
	{
		...
		[PXDBString(15, IsUnicode = true, IsKey = true)]
		[PXDefault]
		[PXParent(typeof(Select<SOOrder, Where<SOOrder.orderType, Equal<Current<SOInvoiceDiscountDetail.orderType>>, And<SOOrder.orderNbr, Equal<Current<SOInvoiceDiscountDetail.orderNbr>>>>>))]
