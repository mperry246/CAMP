...
namespace PX.Objects.CR
{
	...
	public partial class ContactExtAddress : Address, IDefAddressAccessor
	{
		...
		public abstract class contactBAccountID : PX.Data.IBqlField
		{
		}
		...
		[PXUIField(DisplayName = Messages.Position)]
		...
		public abstract class contactNoteID : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region CreatedByID
		public abstract class contactCreatedByID : PX.Data.IBqlField
		{
		}
		...
		public abstract class contactCreatedByScreenID : PX.Data.IBqlField
		{
		}
		...
		public abstract class contactCreatedDateTime : PX.Data.IBqlField
		{
		}
		...
		public abstract class contactLastModifiedByID : PX.Data.IBqlField
		{
		}
		...
		public abstract class contactLastModifiedByScreenID : PX.Data.IBqlField
		{
		}
		...
		public abstract class contactLastModifiedDateTime : PX.Data.IBqlField
		{
		}
		...
		#endregion
        #region ExtraFields
        public abstract class contactDisplayName : PX.Data.IBqlField
        {
        }
