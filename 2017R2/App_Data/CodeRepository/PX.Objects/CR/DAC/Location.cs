...
namespace PX.Objects.CR
{
	...
	public partial class Location : PX.Data.IBqlTable, IPaymentTypeDetailMaster, ILocation
	{
		...
		[Branch(null, IsDetail = false, PersistingCheck = PXPersistingCheck.Nothing, DisplayName = "Shipping Branch", IsEnabledWhenOneBranchIsAccessible = true)]
		...
		[Branch(null, IsDetail = false, PersistingCheck = PXPersistingCheck.Nothing, DisplayName = "Receiving Branch", IsEnabledWhenOneBranchIsAccessible = true)]
		...
		public abstract class vDiscountAcctID : IBqlField { }
		...
		public abstract class vDiscountSubID : IBqlField { }
