...
namespace PX.Objects.CR
{
	...
	public class CRLeadContactValidationProcess : PXGraph<CRLeadContactValidationProcess>
	{
		...
		public partial class ValidationFilter : IBqlTable
		{
			...
			public abstract class closeNoActivityLeads : IBqlField { }
			...
			public abstract class closeThreshold : IBqlField { }
		...
		public partial class Contact2 : Contact
		{
			...
			public new abstract class duplicateStatus : IBqlField { }
			public new abstract class status : IBqlField { }
			public new abstract class contactType : IBqlField { }
		...
		private static void ProcessValidation(ValidationFilter Filter, Contact record)
		{
						...
						score > Filter.CloseThreshold)
				{
					CRActivity activity = PXSelect<CRActivity, 
						Where<CRActivity.refNoteID, Equal<Required<Contact.noteID>>>>.SelectWindowed(graph, 0, 1, contact.NoteID);
