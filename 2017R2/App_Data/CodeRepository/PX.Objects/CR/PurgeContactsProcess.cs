...
namespace PX.Objects.CR
{
	public class PurgeContactsProcess : PXGraph<PurgeContactsProcess>
	{
		...
		public PXSelect<CRPMSMEmail, Where<CRPMSMEmail.refNoteID, Equal<Optional<Contact.noteID>>>> Activities;
			...
			Items.SetProcessDelegate(delegate(PurgeContactsProcess graph, Contact contact)
				{
					...
					foreach (CRPMSMEmail activity in graph.Activities.Select(new object[]{contact.NoteID}))
					{
