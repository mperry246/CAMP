...
namespace PX.Objects.CR
{
	...
	public static class Messages
	{
		...
		public const string AttributeCannotDeleteActive = "Active attribute cannot be deleted";
		...
		public const string PurgeLimitCannotBeLessThanInCRSetup = "This value cannot be less than the default value specified on the Customer Management Preferences (CR101000) form.";
	    ...
	    public const string ReplaceContactDetails = "Would you like to replace contact details?";
