...
namespace PX.Objects.EP
{
	...
	public class EPEmployeePosition : PX.Data.IBqlTable
    {
		...
		#endregion
		#region StartReason
		public abstract class startReason : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region TermReason
		public abstract class termReason : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region IsTerminated
		public abstract class isTerminated : PX.Data.IBqlField
		{
		}
		...
		#region IsRehirable
		public abstract class isRehirable : PX.Data.IBqlField
		{
		}
	...
	public static class EPTermReason
	{
        ...
        public const string MedicalIssues = "MIS";
		 ...
		 public class deseased : Constant<string>
        {
