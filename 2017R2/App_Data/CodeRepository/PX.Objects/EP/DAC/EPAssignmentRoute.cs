...
namespace PX.Objects.EP
{
	...
	public partial class EPAssignmentRoute : PX.Data.IBqlTable
	{
		...
		public abstract class assignmentRouteID : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region Parent
		public abstract class parent : PX.Data.IBqlField
		{
		}
		...
		#endregion		
		#region RouterType
		public abstract class routerType : PX.Data.IBqlField
		{
		}
		...
		#endregion		
		#region OwnerSource
		public abstract class ownerSource : PX.Data.IBqlField
		{
		}
		...
		public abstract class useWorkgroupByOwner : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region RuleType
		public abstract class ruleType : PX.Data.IBqlField
		{
		}
		...
		#region Icon
		public abstract class icon : PX.Data.IBqlField
		{
		}
	...
	public static class EPRouterType
	{
		...
		public class router : Constant<string>
		{
			public router() : base(Router)
			{
			}
		}
		public class group : Constant<string>
		{
			public group() : base(Group)
			{
			}
		}
		public class workgroup : Constant<string>
		{
