...
namespace PX.Objects.EP
{
	...
	[PXEMailSource]
	public partial class EPExpenseClaim : IBqlTable, PX.Data.EP.IAssign
	{
		#region BranchID
		...
		#endregion
		#region ApproveDate
		public abstract class approveDate : IBqlField
		{
		}
		...
		/// </summary>
		/// <value>
		/// Corresponds to the value of the <see cref="FinPeriod.FinPeriodID"/> field.
		/// </value>
		...
		/// <summary>
		/// The type of AP document created as a result of claim release.
		/// </summary>
		/// <value>
		/// The field can have one of the following values, which are described in <see cref="APDocType.ListAttribute"/>:
		/// <c>"ADR"</c>: Debit Adj.,
		/// <c>"INV"</c>: Bill
		/// </value>
		[PXDBString(3, IsFixed = true)]
		[Obsolete("Field is obsolete and will be removed in Acumatica 2018 R1")]
		[APDocType.List]
		...
		/// <summary>
		/// The reference number of the AP document, which is a link that opens the Bills and Adjustments (AP301000) form 
		/// (which corresponds to the <see cref="APInvoiceEntry"/> graph) filled in with the details of the AP document.
		/// </summary>
		...
		#endregion
		#region APStatus
		public abstract class aPStatus : IBqlField
		{
		}
		
		/// <summary>
		/// The status of the AP document.
		/// </summary>
		/// <value>
		/// The field can have one of the values described in <see cref="APDocStatus.ListAttribute"/>.
		/// </value>
