...
namespace PX.Objects.EP
{
	public class EmployeeActivitiesEntry : PXGraph<EmployeeActivitiesEntry>
	{
		...
		[PXDimensionSelector(ContractAttribute.DimensionName,
			...
			, Where<Contract.isTemplate, Equal<boolFalse>, And<ContractExEx.baseType, Equal<Contract.ContractBaseType>>>>),
		...
		public class PMTimeActivityFilter : OwnedFilter
		{
			...
			[EPTimecardProjectTask(typeof(projectID), GL.BatchModule.TA, DisplayName = "Project Task")]
