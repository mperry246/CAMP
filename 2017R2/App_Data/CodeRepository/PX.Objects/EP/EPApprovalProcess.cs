...
namespace PX.Objects.EP
{
	...
	public class EPApprovalProcess : PXGraph<EPApprovalProcess>
	{
		...
		public partial class EPOwned : EPApproval
		{
			...
			public new abstract class pendingWaitTime : PX.Data.IBqlField
			{
			}
			[PXInt]
			...
			[PXDBCalced(typeof(Switch<Case<Where<EPApproval.pendingWaitTime, Greater<EPApproval.waitTime>>, True>, False>), typeof(bool))]
