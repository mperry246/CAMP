...
namespace PX.Objects.EP
{
	...
	public static class Messages
	{
		...
		public const string TipItemIsNotDefined = "To be able to specify a non-zero tip amount in the expense receipt, specify an appropriate tip item in the Non-Taxable Tip Item box on the Time & Expenses Preferences (EP101000) form.";
        ...
        public const string TaxZoneCalcModeChangeOnReceiptsForm = "To change the tax zone and the tax calculation mode in an expense receipts, use the Expense Receipt (EP301010) form.";
