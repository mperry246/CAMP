...
namespace PX.Objects.EP
{
	public class ActivityService : IActivityService
	{
		...
		private class ActivityTypeDeinition : IPrefetchable
		{
			...
			void IPrefetchable.Prefetch()
			{
				...
				List.AddRange(
					...
					Where<EPActivityType.active, Equal<True>, And<EPActivityType.isInternal, Equal<True>>>>.Select(new PXGraph()).RowCast<EPActivityType>());				
			}
		}
		...
		public virtual void CreateActivity(object refNoteID, string typeCode, Guid? owner)
		{
			CreateActivity(CRActivityClass.Activity, (Guid?)refNoteID, typeCode, owner);
		}
