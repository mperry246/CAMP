...
namespace PX.Objects.EP
{
	public class EPAssignmentAndApprovalMapEnq : PXGraph<EPAssignmentAndApprovalMapEnq>
	{
		...
		public PXSelectOrderBy<EPAssignmentMap,
			OrderBy<Desc<EPAssignmentMap.createdDateTime>>>
			Maps;

		public PXSelect<EPAssignmentMap,
			Where<EPAssignmentMap.assignmentMapID, Equal<Required<EPAssignmentMap.assignmentMapID>>>>
			MapsForRedirect;
		#endregion
		...
		[PXButton(ImageKey = Sprite.Main.RecordEdit, Tooltip = "Navigate to the selected map")]
		...
		private PXFieldState CreateFieldStateForEntity(object returnState, string entityType, string graphType)
		{
			...
			else if (entityType != null)
			{
				...
				gType = EntityHelper.GetPrimaryGraphType(this, eType);
			}
