...
namespace PX.Objects.CS
{
	...
	{	
		...
		[PXSelector(typeof(Search<PMProject.contractCD, Where<PMProject.isTemplate, Equal<False>, 
			And<PMProject.baseType, Equal<PMProject.ProjectBaseType>, And<PMProject.nonProject, Equal<False>>>>>),
