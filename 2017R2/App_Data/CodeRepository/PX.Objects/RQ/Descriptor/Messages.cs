...
namespace PX.Objects.RQ
{
	...
	public static class Messages
	{
		...
		public const string InventoryIDShouldBeDefined = "The InventoryID should be defined, before requisition creation.";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string MailSendFailedFormat = "Mail send failed for '{0}'.";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string RequisitionVendor = "Requisition Vendor";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string RequisitionShippingAddress = "Requisition Shipping Address";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string RequestItemShippingAddress = "Request Shipping Address";
		#endregion
