...
namespace PX.Objects.IN
{
    ...
    [PXProjection(typeof(Select5<INLocationStatus2, 
        ...
        ,Aggregate<GroupBy<INTransitLine.transferNbr, GroupBy<INTransitLine.transferLineNbr, Sum<INLocationStatus2.qtyOnHand, Sum<INLocationStatus2.qtyInTransit, Sum<INLocationStatus2.qtyInTransitToSO>>>>>>>), Persistent = false)]
    public partial class INTransitLineStatus : PX.Data.IBqlTable
    {
        #region InventoryID
