...
{
	using SelectParentItemClass = Select<INItemClass, Where<INItemClass.itemClassID, Equal<Current<INItemClass.parentItemClassID>>>>;
	...
	public partial class INItemClass : PX.Data.IBqlTable, PX.SM.IIncludable
	{
		...
		public class dimension : Constant<String> { public dimension() : base(Dimension) { } }
		...
		public abstract class itemClassStrID : PX.Data.IBqlField { }
		[PXString]
		[PXUIField(Visible = false, Visibility = PXUIVisibility.Invisible)]
	...
	public class INDemandCalculation
	{
		...
		public class itemClassSettings : Constant<string>
		{
			public itemClassSettings() : base(ItemClassSettings) { }
		}

		public class hardDemand : Constant<string>
		{
