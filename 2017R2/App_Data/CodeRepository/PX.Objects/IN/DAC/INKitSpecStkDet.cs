...
namespace PX.Objects.IN
{
	...
	public partial class INKitSpecStkDet : PX.Data.IBqlTable
	{
		...
		[PXParent(typeof(Select<INKitSpecHdr, Where<INKitSpecHdr.kitInventoryID, Equal<Current<INKitSpecStkDet.kitInventoryID>>,
			And<INKitSpecHdr.revisionID, Equal<Current<INKitSpecStkDet.revisionID>>>>>))]
		...
		public abstract class compSubItemID : PX.Data.IBqlField
		{
		}
		...
		public abstract class disassemblyCoeff : PX.Data.IBqlField
		{
		}
		...
		public abstract class allowSubstitution : PX.Data.IBqlField
		{
		}
