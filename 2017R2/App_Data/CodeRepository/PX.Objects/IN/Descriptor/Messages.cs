...
namespace PX.Objects.IN
{
	...
	public static class Messages
	{
		...
		public const string DuplicateItemClassID = "The item class ID that you have entered already exists. Please enter a unique item class ID.";
		...
		public const string FinancialPeriodClosedInIN = "Financial period '{0}' is closed in the Inventory module.";
