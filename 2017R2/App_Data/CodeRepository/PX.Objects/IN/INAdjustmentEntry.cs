...
namespace PX.Objects.IN
{
	public class INAdjustmentEntry : PXGraph<INAdjustmentEntry, INRegister>
	{
		...
		protected virtual void INRegister_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
            ...
            bool allowInsertDeleteDetails = (((INRegister)e.Row).OrigModule != GL.BatchModule.PO);
			...
			addInvBySite.SetEnabled(e.Row != null && allowUpdateDelete && allowInsertDeleteDetails);
			...
			transactions.Cache.AllowInsert = allowUpdateDelete && allowInsertDeleteDetails;
			transactions.Cache.AllowUpdate = allowUpdateDelete;
			transactions.Cache.AllowDelete = allowUpdateDelete && allowInsertDeleteDetails;
