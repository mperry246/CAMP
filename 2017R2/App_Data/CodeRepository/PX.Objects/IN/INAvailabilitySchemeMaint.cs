...
namespace PX.Objects.IN
{
	public class INAvailabilitySchemeMaint : PXGraph<INAvailabilitySchemeMaint, INAvailabilityScheme>
	{
		...
		{
			var itemClass = (INItemClass)PXSelect<INItemClass, Where<INItemClass.availabilitySchemeID, Equal<Current<INAvailabilityScheme.availabilitySchemeID>>>>.SelectWindowed(this, 0, 1);
			if (itemClass != null)
			{
