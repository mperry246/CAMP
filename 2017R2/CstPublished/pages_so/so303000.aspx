							...
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="RefNbr,LineNbr">
								<Columns>
									<px:PXGridColumn DataField="BranchID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" AutoCallBack="True" RenderEditorText="True"
										AllowShowHide="Server" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TranType" Width="30px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="RefNbr" Width="90px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="LineNbr" TextAlign="Right" Width="54px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SortOrder" TextAlign="Right" Width="54px" ></px:PXGridColumn>
									<px:PXGridColumn AllowUpdate="False" DataField="LineType" ></px:PXGridColumn>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="SOOrderType" ></px:PXGridColumn>
									<px:PXGridColumn AllowUpdate="False" DataField="SOOrderNbr" Width="108px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" AutoCallBack="True" RenderEditorText="True"
										LinkCommand="ViewItem" AllowDragDrop="true" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowUpdate="False" DataField="SubItemID" DisplayFormat="#" Label="Subitem" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SMEquipmentID" Width="70" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SuspendedSMEquipmentID" Width="70" ></px:PXGridColumn>
									<px:PXGridColumn DataField="NewTargetEquipmentLineNbr" Width="70" ></px:PXGridColumn>
									<px:PXGridColumn DataField="ComponentID" Width="70" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SOID" Width="70" Visible="False" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AppointmentID" Width="80" Visible="False" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TranDesc" Width="180px" AllowDragDrop="true" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="Qty" TextAlign="Right" Width="81px" CommitChanges="True" AllowDragDrop="true" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="BaseQty" TextAlign="Right" Width="81px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="UOM" Width="54px" AutoCallBack="True" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="CuryUnitPrice" TextAlign="Right" Width="81px" CommitChanges="true" ></px:PXGridColumn>
									<px:PXGridColumn DataField="ManualPrice" TextAlign="Center" Type="CheckBox" CommitChanges="true" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="DiscPct" TextAlign="Right" Width="108px" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="CuryDiscAmt" TextAlign="Right" Width="81px" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="ManualDisc" TextAlign="Center" Type="CheckBox" ></px:PXGridColumn>
									...
									<px:PXGridColumn AllowNull="False" DataField="CuryTranAmt" TextAlign="Right" Width="81px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AccountID" DisplayFormat="&gt;#####" Width="108px" AutoCallBack="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AccountID_Account_description" Width="120px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SubID" DisplayFormat="&gt;AA-AA-AA-AA-AA-AA" Width="180px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TaskID" DisplayFormat="&gt;AAAAAAAAAA" Label="Task" Width="81px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="CostCodeID" Label="Task" Width="81px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SalesPersonID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" RenderEditorText="True" AutoCallBack="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="DeferredCode" DisplayFormat="&gt;aaaaaaaaaa" Label="Deferral Code" Width="81px" CommitChanges="true" ></px:PXGridColumn>
									...
									<px:PXGridColumn DataField="DefScheduleID" Label="Deferral Schedule" TextAlign="Right" Width="108px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TaxCategoryID" ></px:PXGridColumn>
									<px:PXGridColumn AllowNull="False" DataField="Commissionable" TextAlign="Center" Type="CheckBox" Width="80px" AutoCallBack="True" ></px:PXGridColumn>
									<px:PXGridColumn AllowUpdate="False" DataField="SOOrderLineNbr" Width="90px" ></px:PXGridColumn>
								...
								<RowTemplate>
									...
									<px:PXSegmentMask CommitChanges="True" ID="edInventoryID" runat="server" DataField="InventoryID" AllowEdit="True" Size="XM" ></px:PXSegmentMask>
                                    <px:PXSegmentMask ID="edSubItemID" runat="server" DataField="SubItemID" Enabled="False" ></px:PXSegmentMask>
									<px:PXSelector runat="server" ID="edSMEquipmentID" DataField="SMEquipmentID" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="CstPXSelectorSuspendedSMEquipmentID" DataField="SuspendedSMEquipmentID" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="CstPXSelectorComponentID" DataField="ComponentID" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector ID="edSOShipmentNbr" runat="server" DataField="SOShipmentNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
									<px:PXTextEdit ID="edSOOrderType1" runat="server" DataField="SOOrderType" Enabled="False" ></px:PXTextEdit>
									<px:PXSelector ID="edSOOrderNbr1" runat="server" DataField="SOOrderNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector CommitChanges="True" ID="edUOM" runat="server" DataField="UOM">
										<Parameters>
											<px:PXControlParam ControlID="grid" Name="ARTran.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
										</Parameters>
									</px:PXSelector>
									...
									<px:PXSelector ID="edDiscountCode" runat="server" DataField="DiscountID" AllowEdit="True" edit="1" ></px:PXSelector>
									<px:PXLayoutRule runat="server" ColumnSpan="2" ></px:PXLayoutRule>
									<px:PXTextEdit ID="edTranDesc1" runat="server" DataField="TranDesc" ></px:PXTextEdit>
									...
									<px:PXSegmentMask ID="edTaskID" runat="server" DataField="TaskID" ></px:PXSegmentMask>
									<px:PXNumberEdit ID="edCuryTranAmt1" runat="server" DataField="CuryTranAmt" Enabled="False" ></px:PXNumberEdit>
									<px:PXSegmentMask ID="edAccountID1" runat="server" DataField="AccountID" AutoRefresh="True" ></px:PXSegmentMask>
									<px:PXSegmentMask ID="edSubID1" runat="server" DataField="SubID" AutoRefresh="True">
										<Parameters>
											<px:PXControlParam ControlID="grid" Name="ARTran.accountID" PropertyName="DataValues[&quot;AccountID&quot;]" Type="String" ></px:PXControlParam>
										</Parameters>
									</px:PXSegmentMask>
									<px:PXSegmentMask ID="edSalesPersonID1" runat="server" DataField="SalesPersonID" ></px:PXSegmentMask>
									<px:PXSelector ID="edTaxCategoryID1" runat="server" DataField="TaxCategoryID" AutoRefresh="True" ></px:PXSelector>
									<px:PXCheckBox CommitChanges="True" ID="chkCommissionable" runat="server" Checked="True" DataField="Commissionable" ></px:PXCheckBox>
									...
									<px:PXSelector ID="edDefScheduleID" runat="server" DataField="DefScheduleID" ></px:PXSelector>
