...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXSelector runat="server" ID="CstPXSelector2" DataField="CustomerLocationID" />
	<px:PXSelector runat="server" ID="CstPXSelector4" DataField="UsrLineofBusiness" />
	<px:PXSelector runat="server" ID="CstPXSelector3" DataField="UsrContractTypeID" />
	<px:PXSelector runat="server" ID="CstPXSelector5" DataField="ClassID" />
	...
	<px:PXTextEdit runat="server" ID="CstPXTextEdit6" DataField="ExtRef1" />
	...
	<px:PXDateTimeEdit runat="server" ID="CstPXDateTimeEdit8" DataField="CancelOn" />
	<px:PXSelector runat="server" ID="CstPXSelector7" DataField="CancelCode" /></Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<px:PXGridColumn DataField="UsrManufacturerID" Width="70" />
	<px:PXGridColumn DataField="UsrTapeModelID" Width="70" DisplayMode="Hint" />
	<px:PXGridColumn DataField="UsrSerialNbr" Width="200" />
	<px:PXGridColumn DataField="UsrPRegNbr" Width="200" />
	...
	<px:PXTextEdit runat="server" ID="CstPXTextEdit9" DataField="Descr" />
