                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions" DataKeyNames="ShipmentNbr,LineNbr">
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="BaseShippedQty" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="UnassignedQty" TextAlign="Right" Width="81px" />
            ...
            <Levels>
                <px:PXGridLevel DataMember="soshipmentplan">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="SOLineSplit__SubItemID" DisplayFormat="&gt;AA-A-A" Width="60px" />
                        <px:PXGridColumn DataField="SOLineSplit__UOM" Width="63px" DisplayFormat="&gt;aaaaaa" />
                        <px:PXGridColumn DataField="SOLineSplit__LotSerialNbr" Width="100px" />
                        <px:PXGridColumn DataField="PlanDate" Label="Plan Date" Width="90px" />
                        <px:PXGridColumn DataField="SOLineSplit__Qty" Width="100px" TextAlign="Right" />
