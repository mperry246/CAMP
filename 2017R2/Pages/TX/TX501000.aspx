	...
	<px:PXGrid ID="grid" runat="server" Height="150px" Width="100%" ActionsPosition="Top" Caption="Details" SkinID="PrimaryInquire">
		<Levels>
			<px:PXGridLevel DataMember="Period_Details">
				<Columns>
					<px:PXGridColumn DataField="LineNbr" TextAlign="Right" Width="64px" />
					<px:PXGridColumn DataField="Descr" Width="360px" />
					<px:PXGridColumn AllowNull="False" DataField="TaxHistory__ReportUnfiledAmt" TextAlign="Right" Width="81px" MatrixMode="true" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
