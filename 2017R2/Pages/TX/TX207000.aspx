...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.TX.TaxYearMaint" PrimaryView="TaxYearFilterSelectView">
		<CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataMember="TaxPeriodExSelectView">
			    <RowTemplate>
                    ...
                    <px:PXSelector ID="edTaxPeriodID" runat="server" DataField="TaxPeriodID"/> 
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="StartDateUI" Width="80px" DisplayFormat="d" />
                    <px:PXGridColumn DataField="EndDateUI" Width="80px" DisplayFormat="d" />
