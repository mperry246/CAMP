...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TxCategory" TypeName="PX.Objects.TX.TaxCategoryMaint">
		<CallbackCommands>
    ...
    SkinID="Details">
		<Levels>
			<px:PXGridLevel DataMember="Details">
				<Columns>
					<px:PXGridColumn DataField="TaxID" Width="81px" AllowShowHide="False" AutoCallBack="True"/>
					<px:PXGridColumn DataField="Tax__Descr" Width="180px" />
					<px:PXGridColumn DataField="Tax__TaxType" Width="162px"  Type ="DropDownList"/>
					<px:PXGridColumn DataField="Tax__TaxCalcRule" Width="162px" Type ="DropDownList"/>
					<px:PXGridColumn DataField="Tax__TaxApplyTermsDisc" Width="207px" Type ="DropDownList"/>
				</Columns>
				<RowTemplate>
					<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
