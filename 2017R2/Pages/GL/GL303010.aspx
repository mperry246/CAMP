...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.GL.JournalEntryImport" PrimaryView="Map">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server"   Width="100%" DataMember="Map" Caption="Import Summary" NoteIndicator="True" FilesIndicator="True"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
			<px:PXNumberEdit CommitChanges="True" ID="edDebitTotal" runat="server" DataField="DebitTotalBalance" Enabled="False" />
			<px:PXNumberEdit CommitChanges="True" ID="edCreditTotal" runat="server" DataField="CreditTotalBalance" Enabled="False" />
						...
						<Levels>
							<px:PXGridLevel DataMember="MapDetails" ImportDataMember="ImportTemplate">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ImportAccountCD" Width="120px" CommitChanges="True" />
									<px:PXGridColumn DataField="MapAccountID" Width="120px" />
									<px:PXGridColumn DataField="ImportSubAccountCD" Width="150px" CommitChanges="True" />
									<px:PXGridColumn DataField="MapSubAccountID" Width="150px" />
									<px:PXGridColumn DataField="YtdBalance" TextAlign="Right" Width="100px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="CuryYtdBalance" TextAlign="Right" Width="100px" AllowShowHide="Server" CommitChanges="True" />
									<px:PXGridColumn DataField="AccountType" Width="60px" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Exceptions">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="EndBalance" TextAlign="Right" Width="100px" />
								</Columns>
