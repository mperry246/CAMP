    ...
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		...
		<Levels>
            <px:PXGridLevel DataMember="GLTranForReclass">
				...
				<Columns>
				    <px:PXGridColumn DataField="Selected" TextAlign="Center" Type="CheckBox" Width="30px" AllowCheckAll="True" CommitChanges="True" />
					...
					<px:PXGridColumn DataField="NewAccountID_Account_description" Width="120px" />
					<px:PXGridColumn DataField="NewSubID" Width="120px"  CommitChanges="True"/>
                    <px:PXGridColumn DataField="NewTranDate" Width="100px" DisplayFormat="d"  CommitChanges="True"/>
                    <px:PXGridColumn DataField="NewTranDesc" Width="180px" />

				    <px:PXGridColumn DataField="Module" TextAlign="Right" />
				    <px:PXGridColumn DataField="BatchNbr" TextAlign="Right" Width="120px" />
                    ...
                    <px:PXGridColumn DataField="ReferenceID" Width="100"/>
                    <px:PXGridColumn DataField="RefNbr" Width="90" LinkCommand="ViewDocument"/>
				</Columns>
    ...
    <px:PXSmartPanel ID="pnlLoadOpts" runat="server" Style="z-index: 108;" Caption="Load Transactions" CaptionVisible="True" Key="LoadOptionsView" AutoReload="true" LoadOnDemand="true">
     ...
     <px:PXSmartPanel ID="pnlRepalceOpt" runat="server" Style="z-index: 108;" Caption="Find and Replace" CaptionVisible="True" Key="ReplaceOptionsView" AutoReload="true" LoadOnDemand="true">
		<px:PXFormView ID="roform" runat="server" Style="z-index: 100;" DataMember="ReplaceOptionsView" CaptionVisible="False" DefaultControlID="edOldBranchID" SkinID="Transparent">
			...
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" GroupCaption="FIND" StartGroup="True" />
                ...
                <px:PXLayoutRule runat="server" GroupCaption="REPLACE WITH" StartGroup="True" />
