...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="Filter" TypeName="PX.Objects.GL.GLBudgetEntry"
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="server">
			...
			<px:PXGrid ID="grid" runat="server" Height="150px" Width="100%" Caption="Budget Articles"
				...
				<Levels>
					<px:PXGridLevel DataMember="BudgetArticles">
						<Columns>
							<px:PXGridColumn DataField="IsGroup" TextAlign="Center" Type="CheckBox" Width="53px" />
							<px:PXGridColumn DataField="Released" TextAlign="Center" Type="CheckBox" Width="53px"
								AutoCallBack="True" />
							<px:PXGridColumn DataField="AccountID" Width="80px" AutoCallBack="True" />
							<px:PXGridColumn DataField="SubID" Width="108px" AutoCallBack="True" />
							<px:PXGridColumn DataField="Description" Width="108px" AllowSort="False" />
							<px:PXGridColumn DataField="Amount" TextAlign="Right" Width="60px" />
							<px:PXGridColumn DataField="AllocatedAmount" TextAlign="Right" Width="60px" />
                            <px:PXGridColumn DataField="CreatedByID" AllowShowHide="True" Width="120px" />
                            <px:PXGridColumn DataField="LastModifiedByID" AllowShowHide="True" Width="120px" />
						</Columns>
						<RowTemplate>
	...
	<px:PXSmartPanel ID="spPreloadArticlesDlg" runat="server" CommandName="preload" CommandSourceID="ds"
        ...
        <px:PXWizard ID="PXWizard1" runat="server" Width="400" Height="240" DataMember="PreloadFilter"
			SkinID="Flat">
			<SaveCommand Target="ds" Command="preload" />
						...
						<px:PXFormView ID="formPanel" runat="server" SkinID="Transparent" DataMember="PreloadFilter">
							<Template>
								...
								<px:PXPanel ID="pnl2" runat="server" Caption="Test" RenderStyle="Simple" Style="padding-left: 10px">
									...
									<px:PXSelector ID="prLedgerID" runat="server" CommitChanges="True" DataField="ledgerID" />
