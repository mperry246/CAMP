						...
						<Levels>
							<px:PXGridLevel DataMember="GLTranModuleBatNbr" DataKeyNames="Module,BatchNbr,LineNbr"
								...
								<Columns>
									...
									<px:PXGridColumn DataField="Split" Label="Split" AllowUpdate="False" Width="30px" AutoCallBack="True" Type="CheckBox" TextAlign="Center" />
                                    ...
                                    <px:PXGridColumn DataField="CostCodeID" Label="Task" Width="108px" AutoCallBack="True" />									
									...
									<px:PXGridColumn DataField="GroupTranID" Label="GroupTranID" TextAlign="Right" Width="81px" Visible="false" AllowShowHide="Server" />
									<px:PXGridColumn DataField="DocCreated" Label="Doc. Created" Width="54px" Type="CheckBox" TextAlign="Center" />
									<px:PXGridColumn DataField="Released" Label="Released" Width="54px" Type="CheckBox" Visible="false" TextAlign="Center" />									
								</Columns>
							</px:PXGridLevel>
						</Levels>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="ARAdjustments">
										...
										<Columns>
											...
											<px:PXGridColumn AllowNull="False" DataField="WriteOffReasonCode" AutoCallBack="True" TextAlign="Right" Width="81px" />
