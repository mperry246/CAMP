		...
		<Levels>
			<px:PXGridLevel DataMember="GLTranModuleBatNbr">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="TaskID" Label="Task" Width="90px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="CostCodeID" Label="Task" Width="90px" AutoCallBack="True" />
                    ...
                    <px:PXGridColumn DataField="ReclassBatchNbr" TextAlign="Right" Width="120px" LinkCommand="ViewReclassBatch" />
                    
                    <px:PXGridColumn DataField="OrigModule" Width="100px"  AllowShowHide="Server"/>
					<px:PXGridColumn DataField="OrigBatchNbr" Width="100px" LinkCommand="viewOrigBatch" AllowShowHide="Server"/>
