...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.GL.ScheduleMaint"
                    ...
                    <px:PXGrid ID="grid" runat="server" Height="150px" Width="100%" SkinID="DetailsInTab">
                        <Levels>
                            <px:PXGridLevel DataMember="Batch_Detail">
                                <Columns>
                                    <px:PXGridColumn DataField="Module" Width="50px" />
                                    <px:PXGridColumn DataField="BatchNbr" Width="81px" LinkCommand="ViewBatchD" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="LedgerID" Width="108px" />
                                    <px:PXGridColumn DataField="DateEntered" Width="90px" />
                                    <px:PXGridColumn DataField="FinPeriodID" Width="63px" />
                                    <px:PXGridColumn DataField="CuryControlTotal" TextAlign="Right" Width="81px" />
                    ...
                    <px:PXGrid ID="grid2" runat="server" Height="171px" Width="100%" SkinID="DetailsInTab">
                        <Levels>
                            <px:PXGridLevel DataMember="Batch_History">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="Module" Type="DropDownList" Width="50px" />
                                    <px:PXGridColumn DataField="BatchNbr" Width="81px" />
                                    <px:PXGridColumn DataField="LedgerID" Width="108px" />
                                    <px:PXGridColumn DataField="DateEntered" Width="90px" />
                                    <px:PXGridColumn DataField="FinPeriodID" Width="63px" />
                                    <px:PXGridColumn DataField="Status" Width="126px" RenderEditorText="True" />
                                    <px:PXGridColumn DataField="CuryControlTotal" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CuryID" Width="60px" />
                                </Columns>
                            </px:PXGridLevel>
