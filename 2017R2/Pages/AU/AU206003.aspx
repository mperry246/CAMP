<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="AU206003.aspx.cs" Inherits="Page_AU208000"
	 %>
...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<label class="projectLink transparent border-box">Analytical Reports</label>

	<pxa:AUDataSource ID="ds" runat="server" Width="100%" TypeName="PX.SM.ProjectReportDefinitionMaintenance" PrimaryView="Items" Visible="true">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    ...
    <px:PXSmartPanel runat="server" ID="FilterSelectReportDefinition" Width="800px" Height="400px" CaptionVisible="True"
		Caption="Add Report Definition" ShowMaximizeButton="True" Key="ViewSelectReportDefinition" ShowAfterLoad="true" AutoRepaint="True">
        
        <px:PXGrid runat="server" 
			ID="gridAddReportDefinition" DataSourceID="ds" 
			...
			>
			<Levels>
				<px:PXGridLevel DataMember="ViewSelectReportDefinition">
					<Columns>
					    <px:PXGridColumn DataField="Selected" Type="CheckBox" AllowCheckAll="True" Width="70px"/>						
                        <px:PXGridColumn DataField="ReportCode" Width="108px"/>	
                        <px:PXGridColumn DataField="Description" Width="108px"/>	
