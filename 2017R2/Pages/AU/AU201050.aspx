<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="AU201050.aspx.cs" Inherits="Page_AU201050"
	Title="Automation Step Maintenance" %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<pxa:AUDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.SM.AUScreenExtensionMaint"
		PrimaryView="Tables" >
		<CallbackCommands>
	...
	<px:PXSplitContainer runat="server" ID="splitScreens" SplitterPosition="350" Style="border-top: solid 1px #BBBBBB;"  >
			<Template1>
			   <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" SkinID="Primary"
				Width="100%" AdjustPageSize="Auto" BorderWidth="0px"  AllowSearch="True" SyncPosition="true" AllowPaging="false" AutoAdjustColumns="true" Caption="Table" CaptionVisible="true">
					<Levels>
                    ...
                    <AutoCallBack Enabled="true" Command="Refresh" Target="gridFields"/>	
