<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="AU205100.aspx.cs" Inherits="Page_AU204000"
	 %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<%@ Reference Page="~/Pages/AU/AU203000.aspx" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<label class="projectLink transparent border-box">Shared Filters</label>

	<pxa:AUDataSource ID="ds" runat="server" Width="100%" TypeName="PX.SM.ProjectFilterMaintenance" PrimaryView="Items" Visible="true">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	...
	<px:PXSmartPanel runat="server" ID="ViewBaseMethod" Width="600px" Height="400px" CaptionVisible="True"
		Caption="Add Shared Filter" ShowMaximizeButton="True" Overflow="Hidden"  Key="SystemFilters" AutoRepaint="True">

		<px:PXGrid runat="server" ID="gridAddFile" DataSourceID="ds" Width="100%" Height="100px" BatchUpdate="True" AutoAdjustColumns="True" SkinID="Details" FilesIndicator="False" NoteIndicator="False">
			<Levels>
				<px:PXGridLevel DataMember="SystemFilters">
					<Columns>
					    <px:PXGridColumn DataField="Selected" Type="CheckBox" Width="50px"/>
					    <px:PXGridColumn DataField="FilterName" Width="160px"/>
						<px:PXGridColumn DataField="UserName" Width="120px"/>
						<px:PXGridColumn DataField="ScreenID" Width="120px"/>
					</Columns>
				</px:PXGridLevel>
			</Levels>
		    <AutoSize Enabled="True"/>
