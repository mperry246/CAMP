<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="AU210000.aspx.cs" Inherits="Page_AU210000"%>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<%@ Reference Page="~/Pages/AU/AU203000.aspx" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<label class="projectLink transparent border-box">Push Notifications</label>
	<pxa:AUDataSource ID="ds" runat="server" Width="100%" TypeName="PX.SM.ProjectPushMaintenance" PrimaryView="Items" Visible="true">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    ...
    <px:PXSmartPanel runat="server" ID="FilterSelectPushNotification" Width="470px" Height="400px" CaptionVisible="True"
		Caption="Add Push Notifications" ShowMaximizeButton="True" Key="ViewSelectPushNotification" ShowAfterLoad="true" AutoRepaint="True">      
        <px:PXGrid runat="server" 
			ID="gridAddPushNotifications" DataSourceID="ds" 
            ...
            NoteIndicator="False">
			<Levels>
				<px:PXGridLevel DataMember="ViewSelectPushNotification">
					<Columns>
