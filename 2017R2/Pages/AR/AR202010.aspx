...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPriceWorksheetMaint" PrimaryView="Document">
		<CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataMember="Details">
				<RowTemplate>
					...
					<px:PXTextEdit ID="teDescription" runat="server" DataField="Description" />
				...
				<Columns>
					<px:PXGridColumn DataField="PriceType" Width="108px" AutoCallBack="True" />
					<px:PXGridColumn DataField="PriceCode" Width="108px" AutoCallBack="True" />
					<px:PXGridColumn DataField="AlternateID" Width="180px" CommitChanges="true"/>
					<px:PXGridColumn DataField="InventoryID" Width="108px" AutoCallBack="True" CommitChanges="true" />
					...
					<px:PXGridColumn DataField="SiteID" Width="108px" AutoCallBack="True"  />
					<px:PXGridColumn DataField="BreakQty" Width="90px" TextAlign="Right" CommitChanges="true" />
					<px:PXGridColumn DataField="CurrentPrice" TextAlign="Right" Width="81px" />
					<px:PXGridColumn DataField="PendingPrice" TextAlign="Right" Width="81px" />
					<px:PXGridColumn DataField="CuryID" Width="90px" CommitChanges="true" />
			...
			<Levels>
				<px:PXGridLevel DataMember="addItemLookup">
					...
					<Columns>
						...
						<px:PXGridColumn DataField="PriceWorkgroupID" Width="140px" />
						<px:PXGridColumn DataField="PriceManagerID" Width="140px" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
		...
		<div style="padding: 5px">
			<px:PXFormView ID="massCopyForm" runat="server" Width="100%" DataSourceID="ds" SkinID="Transparent" DataMember="CopyPricesSettings">
				<Template>
					...
					<px:PXCheckBox ID="chkIsPromotional" runat="server" DataField="IsPromotional" />
