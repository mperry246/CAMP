	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Caption="Details" AllowSearch="True" AdjustPageSize="Auto" Height="150px" Style="z-index: 100" Width="100%" 
		...
		<Levels>
			<px:PXGridLevel DataMember="History">
				<Columns>
					<px:PXGridColumn DataField="StatementCycleId" Width="120px" SortDirection="Ascending" LinkCommand ="ViewDetails" />
					<px:PXGridColumn DataField="StatementDate" Width="108px" SortDirection="Descending" />
					<px:PXGridColumn DataField="Descr" Width="240px" />
					<px:PXGridColumn DataField="NumberOfDocuments" TextAlign="Right" Width="120px" />
					<px:PXGridColumn DataField="ToPrintCount" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="PrintedCount" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="ToEmailCount" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="EmailedCount" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="NoActionCount" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="EmailCompletion" TextAlign="Right" Width="85px" />
					<px:PXGridColumn DataField="PrintCompletion" TextAlign="Right" Width="85px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
