                            ...
                            <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100"
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="DetailMatchesCA" DataKeyNames="TranID">
                                        ...
                                        <Columns>
                                            <px:PXGridColumn DataField="IsMatched" TextAlign="Center" Type="CheckBox" Width="80px" CommitChanges="True" />
                                            ...
                                            <px:PXGridColumn DataField="OrigRefNbr" Width="150px" LinkCommand="ViewPayment" />
