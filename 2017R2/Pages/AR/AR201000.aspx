...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="600px" Width="100%" DataMember="CurCustomerClassRecord"
		...
		<Items>
			...
			<px:PXTabItem Text="Services Billing" RepaintOnDemand="False" LoadOnDemand="True" VisibleExp="DataControls[&quot;chkServiceManagement&quot;].Value == 1" BindingContext="form">
				<Template>
						...
						<Levels>
							<px:PXGridLevel DataMember="BillingCycles">
								<Columns>
									...
									<px:PXGridColumn DataField="BillShipmentSource" Width="180px" />
