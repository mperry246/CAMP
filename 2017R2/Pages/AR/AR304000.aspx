...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:pxdatasource id="ds" runat="server" visible="True" width="100%" typename="PX.Objects.AR.ARCashSaleEntry" primaryview="Document">
		<CallbackCommands>
		...
		<Items>
					...
					<px:PXGrid ID="grid" runat="server" Style="z-index: 100;" Width="100%" SkinID="DetailsInTab" Height="300px" TabIndex="300" DataSourceID="ds" SyncPosition="true">
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									<px:PXGridColumn DataField="BranchID" Width="81px" AutoCallBack="True" RenderEditorText="True" AllowShowHide="Server" />
									<px:PXGridColumn DataField="InventoryID" Width="81px" AutoCallBack="True" RenderEditorText="True" />
									...
									<px:PXGridColumn DataField="CuryUnitPrice" TextAlign="Right" Width="81px" CommitChanges="true" />
									<px:PXGridColumn DataField="ManualPrice" TextAlign="Center" AllowNull="False" Type="CheckBox" CommitChanges="True"/>
									<px:PXGridColumn DataField="CuryExtPrice" TextAlign="Right" Width="81px" CommitChanges="true" />
									<px:PXGridColumn DataField="DiscPct" TextAlign="Right" Width="108px" />
									<px:PXGridColumn DataField="CuryDiscAmt" TextAlign="Right" Width="81px" />
									...
									<px:PXGridColumn DataField="Commissionable" TextAlign="Center" Type="CheckBox" Width="60px" AutoCallBack="True" />
			...
			<px:PXTabItem Text="Billing Address">
				<Template>
					...
					<px:PXLayoutRule ID="PXLayoutRule2" runat="server" GroupCaption="Print and Email Options" StartColumn="True" StartGroup="True" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Taxes">
								<RowTemplate>
									...
									<px:PXSelector ID="edTaxID" runat="server" DataField="TaxID" SuppressLabel="True" />
								...
								<Columns>
									<px:PXGridColumn AllowUpdate="False" DataField="TaxID" Width="81px" />
					...
					<px:PXGrid ID="grdSalesPerTrans" runat="server" BorderWidth="0px" Height="200px" SkinID="Details" Width="100%" TabIndex="400" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="salesPerTrans">
								...
								<Columns>
									<px:PXGridColumn AutoCallBack="True" DataField="SalespersonID" Width="108px" />
									<px:PXGridColumn DataField="CommnPct" TextAlign="Right" Width="108px" />
									<px:PXGridColumn AllowUpdate="False" DataField="CuryCommnAmt" TextAlign="Right" Width="99px" />
						...
						<Levels>
							<px:PXGridLevel DataMember="ccProcTran" DataKeyNames="TranNbr">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="TranType" Width="140px" />
									<px:PXGridColumn DataField="TranStatus" Width="75px" />
									...
									<px:PXGridColumn DataField="ProcStatus" Width="72px" />
									<px:PXGridColumn DataField="CVVVerificationStatus" Width="171px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
