                    ...
                    <px:PXGrid ID="grid" runat="server" Height="100%" Width="100%" AllowSearch="true"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Document_Detail">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="DocType" Type="DropDownList" Width="117px" />
                                    <px:PXGridColumn DataField="RefNbr" Width="108px" AutoCallBack="True" LinkCommand="ViewDocument" />
                                    <px:PXGridColumn DataField="CustomerID" DisplayFormat="&gt;AAAAAAAAAA" Width="100px" />
                                    <px:PXGridColumn DataField="CustomerID_BAccountR_acctName" Width="140px" />
                                    <px:PXGridColumn DataField="DocDate" Width="90px" />
                                    <px:PXGridColumn DataField="FinPeriodID" DisplayFormat="##-####" Width="63px" />
                                    <px:PXGridColumn DataField="CuryOrigDocAmt" TextAlign="Right" Width="81px" MatrixMode="True" />
                    ...
                    <px:PXGrid ID="grid2" runat="server" Height="100%" Width="100%" AllowSearch="true"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Document_History">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="DocType" Type="DropDownList" Width="117px" />
                                    <px:PXGridColumn DataField="RefNbr" Width="108px" LinkCommand="ViewGenDocument" />
                                    <px:PXGridColumn DataField="CustomerID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" />
                                    <px:PXGridColumn DataField="CustomerID_BAccountR_acctName" Width="140px" />
                                    <px:PXGridColumn DataField="Status" Type="DropDownList" Width="126px" />
                                    <px:PXGridColumn DataField="DocDate" Width="90px" />
                                    <px:PXGridColumn DataField="FinPeriodID" DisplayFormat="##-####" Width="63px" />
                                    <px:PXGridColumn DataField="CuryOrigDocAmt" TextAlign="Right" Width="81px" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryID" DisplayFormat="&gt;LLLLL" Width="54px" />
