...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Sequence" TypeName="PX.Objects.AR.ARDiscountSequenceMaint" PageLoadBehavior="GoFirstRecord"
		BorderStyle="NotSet">
		<CallbackCommands>
					...
					<px:PXGrid runat="server" ID="grid" DataSourceID="ds" Height="144px" BorderStyle="None" SkinID="Details" Width="100%" AllowPaging="false">
						<Levels>
							<px:PXGridLevel DataMember="Details">
								...
								<Columns>
									<px:PXGridColumn DataField="IsActive" TextAlign="Center" Width="60px" Type="CheckBox" CommitChanges="true" />
									<px:PXGridColumn DataField="Quantity" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="Amount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="Discount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="DiscountPercent" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="FreeItemQty" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="PendingQuantity" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="PendingAmount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="PendingDiscount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="PendingDiscountPercent" TextAlign="Right" Width="120px" />
									<px:PXGridColumn DataField="PendingFreeItemQty" TextAlign="Right" Width="120px" />
									<px:PXGridColumn DataField="StartDate" Width="90px" />
									<px:PXGridColumn DataField="LastQuantity" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="LastAmount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="LastDiscount" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="LastDiscountPercent" TextAlign="Right" Width="90px" />
									<px:PXGridColumn DataField="LastFreeItemQty" TextAlign="Right" Width="120px" />
					...
					<px:PXGrid ID="itemsGrid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AllowPaging="false">
						...
						<Levels>
							<px:PXGridLevel DataMember="Items">
								...
								<Columns>
									<px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;CCCCC-CCCCCCCCCCCCCCC" Width="144px" AutoCallBack="True" />
									<px:PXGridColumn AllowUpdate="False" DataField="InventoryItem__Descr" Width="351px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
					</px:PXGrid>
					...
					<px:PXGrid ID="customersGrid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AllowPaging="false">
						...
						<Levels>
							<px:PXGridLevel DataMember="Customers">
								...
								<Columns>
									<px:PXGridColumn DataField="CustomerID" AutoCallBack="true" DisplayFormat="CCCCCCCCCC" Width="81px" />
									<px:PXGridColumn AllowUpdate="False" DataField="Customer__AcctName" Width="351px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
					</px:PXGrid>
					...
					<px:PXGrid ID="customerPriceClassGrid" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AllowPaging="false">
						<Levels>
							<px:PXGridLevel DataMember="CustomerPriceClasses">
								...
								<Columns>
									<px:PXGridColumn DataField="CustomerPriceClassID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" AutoCallBack="true" />
									<px:PXGridColumn AllowUpdate="False" DataField="ARPriceClass__Description" Width="500px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
					...
					<px:PXGrid ID="inventoryPriceClassGrid" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" AllowPaging="false">
						<Levels>
							<px:PXGridLevel DataMember="InventoryPriceClasses">
								...
								<Columns>
									<px:PXGridColumn DataField="InventoryPriceClassID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" AutoCallBack="true" />
									<px:PXGridColumn AllowUpdate="False" DataField="INPriceClass__Description" Width="500px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Branches">
								...
								<Columns>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="Branch__AcctName" Width="500px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Sites">
								...
								<Columns>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="INSite__Descr" Width="500px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
