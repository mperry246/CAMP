		...
		<Levels>
			<px:PXGridLevel DataMember="ARDocumentList">
				<Columns>
					...
					<px:PXGridColumn DataField="RefNbr" Width="100px" LinkCommand="editDetail" />
					<px:PXGridColumn DataField="CustomerID" Width="100px" AllowUpdate="False" LinkCommand="editCustomer" />
                    ...
                    <px:PXGridColumn DataField="CuryID" TextAlign="Right" Width="80px" AllowShowHide="Server" />
					<px:PXGridColumn DataField="CuryDocBal" TextAlign="Right" Width="100px" AllowShowHide="Server" />
					...
					<px:PXGridColumn DataField="ReasonCode" Width="250px" />
				</Columns>
