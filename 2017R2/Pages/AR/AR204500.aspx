...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server" >
		...
		<Template>
			...
			<px:PXGrid ID="gridNS" runat="server" SkinID="ShortList" Width="400px" Height="300px" TabIndex="200" 
				DataSourceID="ds" TemporaryFilterCaption="Filter Applied">
				<Mode InitNewRow="True" AllowSort="False" />
				<Levels>
					<px:PXGridLevel DataMember="PercentList" DataKeyNames="FinChargeID,BeginDate,PercentID">
						<Columns>
							<px:PXGridColumn DataField="BeginDate" TextAlign="Right" Width="150px" CommitChanges="True" />
							<px:PXGridColumn DataField="FinChargePercent" TextAlign="Right" Width="120px" />
						</Columns>
						<RowTemplate>
