...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TranslationParamsFilter" PageLoadBehavior="PopulateSavedValues" TypeName="PX.Objects.CM.TranslationProcess" />
</asp:Content>
    ...
    <px:PXGrid ID="grid" runat="server" Height="150px" Style="z-index: 100;" Width="100%" AllowPaging="True" Caption="Rate Details" ActionsPosition="top" AllowSearch="true"
        ...
        <Levels>
            <px:PXGridLevel DataMember="TranslationCurrencyRateRecords">
                ...
                <Columns>
                    <px:PXGridColumn DataField="CuryRateType" Width="99px" />
                    <px:PXGridColumn DataField="CuryRateType_CurrencyRateType_Descr" Width="99px" />
                    <px:PXGridColumn DataField="FromCuryID" Width="100px" />
                    <px:PXGridColumn DataField="ToCuryID" Width="100px" />
                    <px:PXGridColumn DataField="CuryEffDate" Width="130px" />
                    <px:PXGridColumn DataField="CuryRate" TextAlign="Right" Width="99px" />
                    <px:PXGridColumn DataField="CuryMultDiv" Type="DropDownList" Width="99px" />
                    <px:PXGridColumn DataField="RateReciprocal" TextAlign="Right" Width="99px" />
                    <px:PXGridColumn AllowShowHide="False" DataField="CuryRateID" TextAlign="Right" Visible="False" Width="54px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
