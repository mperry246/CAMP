						...
						<Levels>
							<px:PXGridLevel DataMember="CuryRateRecordsEffDate">
								<Columns>
									...
									<px:PXGridColumn DataField="CuryRate" TextAlign="Right" Width="100px" />
									<px:PXGridColumn DataField="CuryMultDiv" Type="DropDownList" />
									<px:PXGridColumn DataField="RateReciprocal" TextAlign="Right" Width="100px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
