                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="Components" >
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="DefAcctID" Width="108px" AutoCallBack="True"/>
                                            <px:PXGridColumn DataField="DefSubID" Width="91px" />
                                            <px:PXGridColumn DataField="AccountID" Width="61px" AutoCallBack="True"/>
                                            <px:PXGridColumn DataField="SubID" Width="108px" />
                                            <px:PXGridColumn DataField="TotalAmt" TextAlign="Right" Width="81px" AutoCallBack="True"/>
