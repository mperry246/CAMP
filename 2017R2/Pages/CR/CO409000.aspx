...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <script type="text/javascript">
		...
		function beforeRedirect(ds, context)
		{
			if (context.info.name == "Emails_ViewDetails")
			{
				var pc = context.popupCommand;
				if (pc) pc.checkSave = false;
			}
		}
	</script>    
	<px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="true" Width="100%"
		...
		<CallbackCommands>
			<px:PXDSCallbackCommand DependOnGrid="gridInbox" Name="Emails_ViewDetails" Visible="False"/>
		...
		<ClientEvents BeforeRedirect="beforeRedirect" />
	</px:PXDataSource>
</asp:Content>
