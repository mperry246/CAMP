	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="198px" DataSourceID="ds" DataMember="OpportunityClassProperties"
		...
		<Items>
            ...
            <px:PXTabItem Text="Stages">
                <Template>
                    <px:PXGrid ID="gridStages" runat="server" DataSourceID="ds" MatrixMode="True" SkinID="Details" SyncPosition="True" TemporaryFilterCaption="Filter Applied" Width="100%">
                        <Levels>
                            <px:PXGridLevel DataMember="OpportunityProbabilities" DataKeyNames="StageCode">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="IsActive" Width="80px" TextAlign="Center" Type="CheckBox" />
                                    <px:PXGridColumn DataField="StageCode" Width="85px" />
                                    <px:PXGridColumn DataField="Name" Width="200px" />
                                    <px:PXGridColumn DataField="Probability" Width="85px" TextAlign="Right" CommitChanges="True" />
                                    <px:PXGridColumn DataField="SortOrder" Width="85px" TextAlign="Right" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
