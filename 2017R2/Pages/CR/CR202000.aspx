...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CR.CampaignMaint"
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewCampaignDocuments" Visible="False" CommitChanges="True" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXSelector ID="edCampaignType" runat="server" AllowNull="False" DataField="CampaignType" AllowEdit="true" CommitChanges="true" />
			...
			<px:PXTabItem Text="Campaign Details">
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple" Style="margin: 9px;">
                        ...
                        <px:PXLayoutRule ID="PXLayoutRule6" runat="server" StartColumn="True" LabelsWidth="SM"	ControlSize="S" />	
                        <px:PXLayoutRule ID="PXLayoutRule1" runat="server" GroupCaption="Planning" StartGroup="True" />
                        ...
                        <px:PXNumberEdit ID="edExpectedResponse" runat="server" DataField="ExpectedResponse" NullText="0.00" />
						<px:PXNumberEdit ID="edPlannedBudget" runat="server" DataField="PlannedBudget" NullText="0.00" />
                        <px:PXNumberEdit ID="edExpectedRevenue" runat="server" DataField="ExpectedRevenue" NullText="0.00" />
                        ...
                        <px:PXNumberEdit ID="edOrderTotal" runat="server" DataField="CalcCampaignCurrent.OrderTotal" NullText="0.00" />
					</px:PXPanel>
					...
					<px:PXGrid ID="gridOpportunities" runat="server" AutoGenerateColumns="AppendDynamic" DataSourceID="ds" Height="423px"
						...
						<Levels>
							<px:PXGridLevel DataMember="Opportunities">
								<Columns>
									<px:PXGridColumn AllowNull="False" DataField="CROpportunityClassID" Width="80px" LinkCommand="Opportunities_CROpportunityClass_ViewDetails" />
									<px:PXGridColumn DataField="OpportunityID" Width="100px" LinkCommand="Opportunities_ViewDetails" />
									<px:PXGridColumn AllowNull="False" DataField="OpportunityName" Width="351px" />
