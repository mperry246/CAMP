			...
			<px:PXTabItem Text="Details" >
				...
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
                        ...
                        <px:PXTimeSpan TimeMode="True" ID="edTimeSpent" runat="server" DataField="TimeActivity.TimeSpent" InputMask="hh:mm"  MaxHours="99" Enabled="False"/>
                        <px:PXTimeSpan TimeMode="True" ID="edOvertimeSpent" runat="server" DataField="TimeActivity.OvertimeSpent" InputMask="hh:mm" MaxHours="99" Enabled="False"/>
                        <px:PXTimeSpan TimeMode="True" ID="edTimeBillable1" runat="server" DataField="TimeActivity.TimeBillable" InputMask="hh:mm" MaxHours="99" Enabled="False"/>
                        <px:PXTimeSpan TimeMode="True" ID="edOvertimeBillable" runat="server" DataField="TimeActivity.OvertimeBillable" InputMask="hh:mm" MaxHours="99" Enabled="False"/>
					...
					<px:PXGrid ID="gridReferencedTasks" runat="server" DataSourceID="ds" Height="323px"
						...
						<Levels>
							<px:PXGridLevel DataMember="ReferencedTasks">
								<Columns>
									<px:PXGridColumn DataField="Subject" Width="300px" LinkCommand="ViewTask" />
