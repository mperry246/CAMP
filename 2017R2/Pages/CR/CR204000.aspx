                    ...
                    <Levels>                        
                        <px:PXGridLevel DataMember="SelectrionCriteria">				                
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="DataField" Type="DropDownList" Width="200px" TextAlign="Left" CommitChanges="True"  />
                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="MailRecipients" >
                            <Columns>                                
                                ...
                                <px:PXGridColumn DataField="ContactID" TextField="ContactBAccount__Contact" Width="200px" 
                                                 AutoCallBack="true" DisplayMode="Text" TextAlign="Left" LinkCommand="Contact_ViewDetails"/>
                                <px:PXGridColumn DataField="Contact__Salutation" Width="150px" />
                                <px:PXGridColumn DataField="Contact__ContactType" Width="150px" />
                                <px:PXGridColumn DataField="Contact__Email" Width="200px" />
                                <px:PXGridColumn DataField="Contact__BAccountID" Width="200px" LinkCommand="BAccount_ViewDetails" />
                                <px:PXGridColumn DataField="Contact__FullName" Width="200px" />
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="DisplayName" Width="130px" LinkCommand="LinkToContact"  />
                    ...
                    <px:PXGridColumn DataField="Salutation" Width="180px" AllowUpdate ="false" />
