		...
		<Items>
			<px:PXTabItem Text="Details" RepaintOnDemand="False">
				<Template>
                    ...
                    <px:PXNumberEdit ID="edReopenCaseTimeInDays" runat="server" DataField="ReopenCaseTimeInDays" Size="XS" />
				</Template>
			</px:PXTabItem>
					...
					<px:PXGrid ID="gridCaseClassesReaction" runat="server" SkinID="Details" DataSourceID="ds"
						...
						<Levels>
							<px:PXGridLevel DataMember="CaseClassesReaction">
								...
								<Columns>
									<px:PXGridColumn DisplayFormat="&gt;a" DataField="Severity" Type="DropDownList" Width="108px" />
									<px:PXGridColumn TextAlign="Right" DataField="TimeReaction" Width="108px" AllowNull="False" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
