...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" TypeName="PX.Objects.RQ.RQBiddingEntry"
					...
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; height: 423px;
						...
						<Levels>
							<px:PXGridLevel DataMember="Lines" >
								<Columns>
									<px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" Width="100px" />
									...
									<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="MinQty" TextAlign="Right" Width="100px" />																					
									<px:PXGridColumn DataField="QuoteQty" Width="100px" AllowNull="False" TextAlign="Right" />									
									<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="CuryQuoteUnitCost" TextAlign="Right" Width="100px" />
									<px:PXGridColumn DataField="QuoteNumber" Width="80px" />									
									<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="CuryQuoteExtCost" TextAlign="Right" Width="110px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
