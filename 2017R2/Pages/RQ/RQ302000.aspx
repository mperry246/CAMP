...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" TypeName="PX.Objects.RQ.RQRequisitionEntry" PrimaryView="Document" BorderStyle="NotSet" Width="100%">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="Action@Complete Bidding"  CommitChanges="True" PopupCommand="Cancel" PopupCommandTarget="ds"/>
        ...
        <px:PXGrid ID="addRequest" runat="server" DataSourceID="ds" Width="100%" Style="border-width: 1px 0px; top: 0px; left: 0px;" AdjustPageSize="Auto" AllowPaging="true" SkinID="Inquire">
            ...
            <Levels>
                <px:PXGridLevel DataMember="SourceRequests">
                    <Columns>
                        <px:PXGridColumn AllowCheckAll="True" AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="20px" AutoCallBack="true" />
                        ...
                        <px:PXGridColumn AllowNull="False" DataField="SelectQty" TextAlign="Right" Width="100px" AutoCallBack="true" />
                        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="OpenQty" TextAlign="Right" Width="100px" />
                        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ReqQty" TextAlign="Right" Width="100px" />
                        ...
                        <px:PXGridColumn DataField="VendorName" Width="100px" />
            ...
            <Levels>
                <px:PXGridLevel DataMember="Contents">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="RQRequest__DepartmentID" DisplayFormat="&gt;aaaaaaaaaa" Width="100px" />
                        ...
                        <px:PXGridColumn DataField="RQRequestLine__Description" Width="150px" AllowUpdate="False" />
                        <px:PXGridColumn DataField="ItemQty" TextAlign="Right" AllowNull="False" Width="80px" />
                        <px:PXGridColumn DataField="RQRequestLine__OpenQty" TextAlign="Right" AllowNull="False" Width="80px" />
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <AutoSize Enabled="true" />
            ...
            <Levels>
                <px:PXGridLevel DataMember="OrderLines">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="POOrder__OrderDate" Width="90px" />
                        ...
                        <px:PXGridColumn DataField="SubItemID" DisplayFormat="&gt;A" />
                        <px:PXGridColumn DataField="UOM" DisplayFormat="&gt;aaaaaa" />
                        <px:PXGridColumn DataField="OrderQty" AllowNull="False" TextAlign="Right" Width="100px" />
                        <px:PXGridColumn DataField="ReceivedQty" AllowNull="False" AllowUpdate="False" TextAlign="Right" Width="100px" />
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <AutoSize Enabled="true" />
        ...
        <px:PXGrid ID="gripSiteStatus" runat="server" DataSourceID="ds" Style="border-width: 1px 0px; top: 0px; left: 0px;" AutoAdjustColumns="true" Width="100%" SkinID="Details"
            ...
            <Levels>
                <px:PXGridLevel DataMember="siteStatus">
                    ...
                    <Columns>
                        <px:PXGridColumn AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="80px" AutoCallBack="true" AllowCheckAll="true" />
    ...
    <px:PXTab ID="tab" runat="server" Height="504px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentDocument">
        ...
        <Items>
            <px:PXTabItem Text="Document Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 388px;" Width="100%" BorderWidth="0px" SkinID="Details" StatusField="Availability" Height="388px" TabIndex="-19336">
                        <Levels>
                            <px:PXGridLevel DataMember="Lines" DataKeyNames="ReqNbr,LineNbr">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="OrderQty" TextAlign="Right" Width="100px" CommitChanges="true" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryEstUnitCost" MatrixMode="True" TextAlign="Right" Width="100px" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="AlternateID" Width="120px" />
                                    <px:PXGridColumn AllowNull="False" DataField="IsUseMarkup" Label="Use Markup %" TextAlign="Center" Type="CheckBox" Width="60px" CommitChanges="True" />
                                    <px:PXGridColumn AllowNull="False" DataField="MarkupPct" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="RcptQtyMin" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="RcptQtyMax" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="RcptQtyThreshold" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="RcptQtyAction" RenderEditorText="True" />
                                    <px:PXGridColumn DataField="RequestedDate" Width="90px" />
                                    <px:PXGridColumn DataField="PromisedDate" Width="90px" />
                                    <px:PXGridColumn DataField="Cancelled" Type="CheckBox" Width="60px" TextAlign="Center" CommitChanges="True"  />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
									...
									<px:PXGrid ID="gridVendor" runat="server" DataSourceID="ds" Width="100%" Height="200px" SkinID="DetailsWithFilter"
										...
										<Levels>
											<px:PXGridLevel DataMember="Vendors" DataKeyNames="LineID">
												...
												<Columns>
													<px:PXGridColumn DataField="VendorID" DisplayFormat="&gt;AAAAAAAAAA" Width="100px" CommitChanges="True" />
													<px:PXGridColumn DataField="VendorID_Vendor_AcctName" Width="300px" />
													<px:PXGridColumn DataField="VendorLocationID" DisplayFormat="&gt;AAAAAA" Width="100px" CommitChanges="True" />
													<px:PXGridColumn DataField="VendorLocationID_Location_Descr" Width="100px" />
													<px:PXGridColumn DataField="CuryInfoID" Width="54px" TextField="CuryID" />
													<px:PXGridColumn DataField="Location__VShipTermsID" Width="80px" />
													<px:PXGridColumn DataField="FOBPoint" DisplayFormat="&gt;aaaaaaaaaaaaaaa" />
													<px:PXGridColumn DataField="Location__VLeadTime" Width="100px" TextAlign="Right" />
													<px:PXGridColumn DataField="ShipVia" DisplayFormat="&gt;aaaaaaaaaaaaaaa" />
													<px:PXGridColumn DataField="ExpireDate" Width="90px" />
													<px:PXGridColumn DataField="PromisedDate" Width="90px" />
													<px:PXGridColumn AllowNull="False" DataField="Status" TextAlign="Center" Type="CheckBox" Width="90px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="POOrders" DataKeyNames="OrderType,OrderNbr">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="CuryLineTotal" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryTaxTotal" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="CuryOrderTotal" TextAlign="Right" AllowNull="False" Width="100px" AllowUpdate="False" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="SOOrders" DataKeyNames="OrderType,OrderNbr">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CustomerID" DisplayFormat="&gt;AAAAAAAAAA" Width="90px" />
                                    <px:PXGridColumn DataField="CustomerLocationID" DisplayFormat="&gt;AAAA" />
                                    <px:PXGridColumn DataField="CuryID" DisplayFormat="&gt;LLLLL" />
                                    <px:PXGridColumn DataField="CuryLineTotal" AllowNull="False" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="CuryTaxTotal" AllowNull="False" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryOrderTotal" TextAlign="Right" Width="100px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" />
