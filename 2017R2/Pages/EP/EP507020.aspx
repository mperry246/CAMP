...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" 
        ...
        <Template>
            ...
            <px:PXSegmentMask runat="server" DataField="ContractID" DataSourceID="ds" ID="edContractID" CommitChanges="True"/>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" 
		Width="100%" Height="150px" SkinID="PrimaryInquire" TabIndex="700" FilesIndicator="False" NoteIndicator="True" SyncPosition="True" FastFilterFields="Owner,Subject" >
		<Levels>
			<px:PXGridLevel DataKeyNames="TaskID" DataMember="Activity">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="ContractID" AutoCallBack="True" Width="120px"  LinkCommand="ViewContract"/>
                    ...
                    <px:PXGridColumn DataField="CRCase__Status" Width="90px" />
