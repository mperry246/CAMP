...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="true" Width="100%"
		PrimaryView="Activities" TypeName="PX.Objects.EP.ActivitiesEnq" PageLoadBehavior="PopulateSavedValues">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="createNew" RepaintControls="All" HideText="True"/>
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phL" runat="server">
	<px:PXGrid ID="gridActivities" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top"
		AllowPaging="true" AdjustPageSize="Auto" AllowSearch="true" SkinID="PrimaryInquire"
