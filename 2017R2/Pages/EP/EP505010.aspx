...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" ActionsPosition="Top"
        Caption="Time Cards" SkinID="PrimaryInquire" SyncPosition="True" FastFilterFields="TimeCardCD,EmployeeID,EmployeeID_description">
        <Levels>
            <px:PXGridLevel DataMember="FilteredItems">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ApprovedByID" Width="108px" />
                    <px:PXGridColumn DataField="ApprovedByName" Width="108px" />
