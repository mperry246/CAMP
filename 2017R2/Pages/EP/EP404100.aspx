...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="server">
	<px:PXGrid ID="gridEvents" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top"
		...
		MatrixMode="true" BlankFilterHeader="All Events" AdjustPageSize="Auto" SkinID="PrimaryInquire" FastFilterFields="Subject" RestrictFields="True">
		...
		<Levels>
			<px:PXGridLevel DataMember="Events">
				<Columns>
					...
					<px:PXGridColumn DataField="UIStatus" AllowNull="False"  Width="80px" />
