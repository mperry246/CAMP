						...
						<Template>
							<px:PXFormView ID="formRuleType" runat="server" Width="100%" DataMember="CurrentNode" DataSourceID="ds" SkinID="Transparent">
								...
								<Template>
									...
									<px:PXTextEdit Size="XM" ID="edRuleName" CommitChanges="True" runat="server" DataField="Name" AutoRefresh="true" />
									<px:PXDropDown Size="XM" ID="edEmptyStepType" CommitChanges="True" runat="server" DataField="EmptyStepType" AllowNull="False" />
								</Template>
							</px:PXFormView>
								...
								<Levels>
									<px:PXGridLevel DataMember="Rules">
										<Columns>
											...
											<px:PXGridColumn Type="DropDownList" DataField="Entity" AllowSort="False" AutoCallBack="True" AllowResize="true" Width="200" />
											<px:PXGridColumn AutoCallBack="True" Type="DropDownList" AllowSort="False" DataField="FieldName" AllowResize="true" Width="130" />
							...
							<px:PXGrid ID="employeeApproveGrid" runat="server" SkinID="Details" DataSourceID="ds" ActionsPosition="Top" Height="110px" Width="100%"
								...
								<Levels>
									<px:PXGridLevel DataMember="EmployeeCondition">
										<Columns>
											<px:PXGridColumn AllowNull="False" DataField="OpenBrackets" Type="DropDownList" Width="70px" AutoCallBack="true" />
											<px:PXGridColumn Type="DropDownList" DataField="Entity" AutoCallBack="True" AllowResize="true" Width="130px" />
											<px:PXGridColumn AutoCallBack="True" Type="DropDownList" DataField="FieldName" AllowResize="true" Width="130px" />
											<px:PXGridColumn AllowNull="False" DataField="Condition" Type="DropDownList" AllowResize="true" />
											<px:PXGridColumn DataField="IsField" Type="CheckBox" TextAlign="Center" Width="70px" AutoCallBack="True"/>
											<px:PXGridColumn DataField="Value" AllowResize="true" />
											<px:PXGridColumn DataField="Value2" AllowResize="true" />
											<px:PXGridColumn AllowNull="False" DataField="CloseBrackets" Type="DropDownList" Width="70px" />
											<px:PXGridColumn AllowNull="False" DataField="Operator" Type="DropDownList" Width="70px" />
										</Columns>
									</px:PXGridLevel>
								</Levels>
								<AutoSize Enabled="true" Container="Window"/>
