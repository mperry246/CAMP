		...
		<Levels>
			<px:PXGridLevel DataKeyNames="NoteID" DataMember="Activity">
			    <RowTemplate>
                    ...
                    <px:PXSelector runat="server" ID="edAppEmpID" DataField="AppEmpID" AutoRefresh="True" CommitChanges="True" />
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="AppointmentID" Width="120px" CommitChanges="True" LinkCommand="OpenAppointment" />
                    <px:PXGridColumn DataField="AppointmentCustomerID" Width="120px" CommitChanges="True" />
                    <px:PXGridColumn DataField="AppEmpID" Width="120px" CommitChanges="True" />
