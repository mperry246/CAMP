	...
	<pxa:PXGridWithPreview ID="gridActivities" runat="server" DataSourceID="ds" Width="100%" Height="420px" 
		...
		<Levels>
			<px:PXGridLevel  DataMember="Activities">
				<Columns>
					...
					<px:PXGridColumn DataField="StartDate" DataType="DateTime" DisplayFormat="g" Width="108px">
						<Header Text="Start Time">
						</Header>
					</px:PXGridColumn>
					<px:PXGridColumn DataField="TimeSpent" Width="63px" DataType="DateTime">
					...
					<px:PXGridColumn DataField="OwnerID" LinkCommand="OpenActivityOwner" Width="150px" />
		...
		<PreviewPanelTemplate>
			<px:PXHtmlView ID="edBody" runat="server" DataField="previewHtml" TextMode="MultiLine" MaxLength="50"
				Width="100%" Height="100%" SkinID="Label">
