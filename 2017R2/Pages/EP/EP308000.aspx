...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="true" Width="100%" TypeName="PX.Objects.EP.EquipmentTimeCardMaint" PrimaryView="Document" PageLoadBehavior="GoLastRecord">
        <CallbackCommands>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Summary">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="RateType" AutoCallBack="true" Width="108px" />
                    ...
                    <px:PXGrid ID="gridActivities" runat="server" DataSourceID="ds" Height="100%" Width="100%" SkinID="DetailsInTab"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                <Columns>
                                    <px:PXGridColumn DataField="Date" Width="90px" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="ProjectID" Width="90px" AutoCallBack="true"/>
                                    <px:PXGridColumn DataField="ProjectTaskID" Width="90px" />
                                     <px:PXGridColumn DataField="CostCodeID" AutoCallBack="true" Width="108px" />
                                    <px:PXGridColumn DataField="SetupTime" Width="90px" AutoCallBack="true" RenderEditorText="True"/>
                                    <px:PXGridColumn DataField="RunTime" Width="90px" AutoCallBack="true" RenderEditorText="True"/>
                                    <px:PXGridColumn DataField="SuspendTime" Width="90px" AutoCallBack="true" RenderEditorText="True"/>
                                    <px:PXGridColumn DataField="IsBillable" Type="CheckBox" Width="63px" />
                                    <px:PXGridColumn DataField="Description" Width="230px" />
