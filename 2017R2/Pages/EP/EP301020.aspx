...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="ClaimDetails"
        ...
        <Template>
            ...
            <px:PXSelector ID="SelectorClaimDetailID" runat="server" DataField="ClaimDetailID" TextField="ClaimDetailID" 
                NullText="<NEW>" Size="s" TabIndex="101"/>
        ...
        <Items>
            <px:PXTabItem Text="Receipt Details">
                <Template>
                    ...
                    <px:PXSegmentMask CommitChanges="True" ID="edCostCode" runat="server" DataField="CostCodeID" AutoRefresh="True" />
					...
					<px:PXGrid ID="grid1" runat="server" Height="100%"
						...
						<Levels>
							<px:PXGridLevel DataMember="Taxes">
								<Columns>
									<px:PXGridColumn DataField="TaxID" Width="100px" CommitChanges="true"  />
