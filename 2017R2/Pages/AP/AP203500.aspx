<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="AP203500.aspx.cs" Inherits="Page_AP203500"
    Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AP.APScheduleMaint"
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="ViewDocument" DependOnGrid="grid" Visible="False" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="ViewGenDocument" DependOnGrid="grid2" Visible="False" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
    ...
    <px:PXTab ID="tab" runat="server" TabIndex="200" Height="100%" Width="100%">
        <Items>
            <px:PXTabItem Text="Document List">
                <Template>
                    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%"
                        Style="z-index: 100" AllowPaging="True" AllowSearch="true" DataSourceID="ds" BorderWidth="0px" SkinID="Details" >
                        <Levels>
                            <px:PXGridLevel DataMember="Document_Detail">
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
                                    <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" AutoRefresh="true" AllowEdit="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="APRegister.docType" PropertyName="DataValues[&quot;DocType&quot;]" Type="String" />
                                        </Parameters>
                                    </px:PXSelector>
                                    ...
                                    <px:PXTextEdit ID="edFinPeriodID" runat="server" DataField="FinPeriodID" Enabled="False" AllowEdit="True" />
                                ...
                                <Columns>
                                    <px:PXGridColumn AllowUpdate="False" DataField="DocType" Type="DropDownList" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" Width="100px" LinkCommand="ViewDocument" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="VendorID" Width="100px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="VendorID_Vendor_acctName" Width="150px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="DocDate" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="FinPeriodID" Width="100px" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryOrigDocAmt" TextAlign="Right" Width="100px" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryID" Width="100px" AllowUpdate="False" />
                                    <px:PXGridColumn AllowNull="False" DataField="DocDesc" Width="200px" AllowUpdate="False" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
            ...
            <px:PXTabItem Text="Generated Documents">
                <Template>
                    <px:PXGrid ID="grid2" runat="server" Height="400px" Width="100%"
                        Style="z-index: 100" AllowPaging="True" ActionsPosition="Top"
                        AllowSearch="true" DataSourceID="ds"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Document_History">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edRefNbr2" runat="server" DataField="RefNbr"
                                        Enabled="False"
                                        AutoRefresh="true" AllowEdit="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid2" Name="APRegister.docType" PropertyName="DataValues[&quot;DocType&quot;]" Type="String" />
                                        </Parameters>
                                    </px:PXSelector>
                                    <px:PXSegmentMask ID="edVendorID2" runat="server" DataField="VendorID" AllowEdit="True" />
                                    <px:PXDateTimeEdit ID="edDocDate2" runat="server" DataField="DocDate" Enabled="False" />
                                    <px:PXTextEdit ID="edFinPeriodID2" runat="server" DataField="FinPeriodID" Enabled="False" AllowEdit="True" />
                                ...
                                <Columns>
                                    <px:PXGridColumn AllowUpdate="False" DataField="DocType" Type="DropDownList" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" Width="100px" LinkCommand="ViewGenDocument" />
                                    <px:PXGridColumn DataField="VendorID" Width="100px" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="VendorID_Vendor_acctName" Width="150px" />
                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="Status" Type="DropDownList" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="DocDate" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="FinPeriodID" Width="100px" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryOrigDocAmt" TextAlign="Right" Width="100px" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryID" Width="100px" AllowUpdate="False" MatrixMode="True" />
                                    <px:PXGridColumn AllowNull="False" DataField="DocDesc" Width="200px" AllowUpdate="False" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
