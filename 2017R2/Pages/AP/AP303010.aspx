...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Location" TypeName="PX.Objects.AP.VendorLocationMaint">
		<CallbackCommands>
							...
							<px:PXGrid ID="grdPaymentDetails" runat="server" SkinID="Attributes" Caption="Payment Instructions" MatrixMode="True" Width="400px" Height="150px">
								<Levels>
									<px:PXGridLevel DataMember="PaymentDetails">
										<Columns>
											<px:PXGridColumn AllowUpdate="False" DataField="PaymentMethodDetail__descr" Width="150px" />
											<px:PXGridColumn AllowShowHide="False" DataField="DetailValue" Width="200px" />
										</Columns>
									</px:PXGridLevel>
								</Levels>
