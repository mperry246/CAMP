                            ...
                            <px:PXGrid ID="gridNS" runat="server" AdjustPageSize="Auto" AllowPaging="True" Caption="Mailings" DataSourceID="ds"
                                ...
                                <Levels>
                                    <px:PXGridLevel DataKeyNames="SourceID,SetupID" DataMember="NotificationSources">
                                        ...
                                        <Columns>
                                            <px:PXGridColumn AutoCallBack="True" DataField="SetupID" Width="100px" />
                                            <px:PXGridColumn AutoCallBack="True" DataField="NBranchID" Label="Branch" Width="100px" />
                                            <px:PXGridColumn DataField="EMailAccountID" Width="200px" DisplayMode="Text" />
                                            <px:PXGridColumn AutoCallBack="True" DataField="ReportID" Width="150px" />
                                            <px:PXGridColumn AutoCallBack="True" DataField="NotificationID" Width="150px" />
                                            <px:PXGridColumn AutoCallBack="True" DataField="Format" RenderEditorText="True" Width="50px" />
                            ...
                            <px:PXGrid ID="gridNR" runat="server" AdjustPageSize="Auto" AllowPaging="True" Caption="Recipients" DataSourceID="ds" SkinID="DetailsInTab"
                                ...
                                <Levels>
                                    <px:PXGridLevel DataKeyNames="NotificationID" DataMember="NotificationRecipients">
                                        ...
                                        <Columns>
                                            <px:PXGridColumn AutoCallBack="True" DataField="ContactType" RenderEditorText="True" Width="100px" />
                                            <px:PXGridColumn AllowShowHide="False" DataField="OriginalContactID" Visible="False" Width="50px" />
                                            <px:PXGridColumn DataField="ContactID" Width="150px" />
                                            <px:PXGridColumn AutoCallBack="True" DataField="Format" RenderEditorText="True" Width="50px" />
                                            <px:PXGridColumn DataField="Active" TextAlign="Center" Type="CheckBox" Width="50px" />
