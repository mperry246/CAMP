		...
		<Levels>
			<px:PXGridLevel DataMember="APDocumentList">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="SuppliedByVendorID" Width="220px" DisplayMode="Hint"/>
					<px:PXGridColumn DataField="SeparateCheck" TextAlign="Center" Type="CheckBox" Width="80px" />
					<px:PXGridColumn DataField="PayDate" Width="90px" CommitChanges="true" />
					...
					<px:PXGridColumn DataField="PayLocationID" Width="81px" />
					<px:PXGridColumn DataField="PayTypeID" Width="81px" CommitChanges="true" />
					<px:PXGridColumn DataField="PayAccountID" Width="81px" CommitChanges="true" />
