...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AP.APPriceWorksheetMaint" PrimaryView="Document">
        <CallbackCommands>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="144px" Style="z-index: 100" Width="100%" Caption="Sales Prices"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Details">
                ...
                <Columns>
                    <px:PXGridColumn DataField="VendorID" Width="108px" AutoCallBack="True"  />
