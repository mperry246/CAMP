    ...
    <px:PXTab ID="tab" runat="server">
        <Items>
            <px:PXTabItem Text="Documents to Pay">
                <Template>
                    <px:PXGrid ID="grid1" runat="server" Height="288px" Style="z-index: 100" Width="100%" AllowPaging="True" AdjustPageSize="Auto" SkinID="Details" DataSourceID="ds" TabIndex="6300">
            ...
            <px:PXTabItem Text="Exceptions">
                <Template>
                    <px:PXGrid ID="grid2" runat="server" Height="288px" Style="z-index: 100" Width="100%" AllowPaging="True" AdjustPageSize="Auto" SkinID="Details" DataSourceID="ds" TabIndex="6300">
                        <Mode InitNewRow="True"></Mode>
                        <Levels>
