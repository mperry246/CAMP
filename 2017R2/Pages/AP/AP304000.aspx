						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="TranType,RefNbr,LineNbr">
								<Columns>
									...
									<px:PXGridColumn DataField="CuryUnitCost" TextAlign="Right" Width="100px" CommitChanges="true" />
									<px:PXGridColumn DataField="ManualPrice" TextAlign="Center" AllowNull="False" Type="CheckBox" CommitChanges="True"/> 
									<px:PXGridColumn DataField="CuryLineAmt" TextAlign="Right" Width="100px" CommitChanges="true" />
