...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Sequence" TypeName="PX.Objects.AP.APDiscountSequenceMaint">
		<CallbackCommands>
                    ...
                    <px:PXGrid ID="itemsGrid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AdjustPageSize="Auto">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Items" DataKeyNames="DiscountID,InventoryID,DiscountSequenceID">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;CCCCC-CCCCCCCCCCCCCCC" Width="144px" CommitChanges="True" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Locations" DataKeyNames="DiscountID,DiscountSequenceID,LocationID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Location__Descr" Width="200px" AllowUpdate="False"/>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                    </px:PXGrid>
