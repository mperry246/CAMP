		...
		<Items>
			<px:PXTabItem Text="Calendar Settings">
				<Template>
					...
					<px:PXDateTimeEdit Size="s" ID="edSunStartTime" runat="server" DataField="SunStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edMonStartTime" runat="server" DataField="MonStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edTueStartTime" runat="server" DataField="TueStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edWedStartTime" runat="server" DataField="WedStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edThuStartTime" runat="server" DataField="ThuStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edFriStartTime" runat="server" DataField="FriStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edSatStartTime" runat="server" DataField="SatStartTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="XXS" LabelsWidth="XXS" />
					<px:PXLabel ID="LL3" runat="server">End time </px:PXLabel>
					<px:PXDateTimeEdit Size="s" ID="edSunEndTime" runat="server" DataField="SunEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edMonEndTime" runat="server" DataField="MonEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edTueEndTime" runat="server" DataField="TueEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edWedEndTime" runat="server" DataField="WedEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edThuEndTime" runat="server" DataField="ThuEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edFriEndTime" runat="server" DataField="FriEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXDateTimeEdit Size="s" ID="edSatEndTime" runat="server" DataField="SatEndTime" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
					<px:PXLayoutRule runat="server" StartColumn="True" ControlSize="XS" LabelsWidth="XXS" />
                    <px:PXLabel ID="LL4" runat="server">Unpaid Break Time</px:PXLabel>
                    <px:PXTimeSpan ID="PXTimeSpan1" runat="server" DataField="SunUnpaidTime" InputMask="hh:mm" LabelID="LL4" LabelPostfix="" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan2" runat="server" DataField="MonUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan3" runat="server" DataField="TueUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan4" runat="server" DataField="WedUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan5" runat="server" DataField="ThuUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan6" runat="server" DataField="FriUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXTimeSpan ID="PXTimeSpan7" runat="server" DataField="SatUnpaidTime" InputMask="hh:mm" SuppressLabel="True"/>
                    <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="XXS" LabelsWidth="XXS" />
						...
						<Levels>
							<px:PXGridLevel DataMember="CSCalendarExceptions">
								...
								<RowTemplate>
									...
									<px:PXDateTimeEdit ID="edStartTime" runat="server" DataField="StartTime" DisplayFormat="t" EditFormat="t" TimeMode="true" T />
