...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="LandedCostCode" Caption="Landed Cost Code"
        ...
        <Template>
            ...
            <px:PXDropDown runat="server" SelectedIndex="2" DataField="ApplicationMethod" AllowNull="False" ID="edApplicationMethod" />
            ...
            <px:PXSegmentMask runat="server" DataField="LCAccrualAcct" ID="edLCAccrualAcct" />
            ...
            <px:PXSegmentMask runat="server" DataField="LCVarianceAcct" ID="edLCVarianceAcct" />
