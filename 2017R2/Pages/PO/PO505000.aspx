...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" SyncPosition="True"
        FastFilterFields="InventoryID,InventoryID_InventoryItem_descr,VendorID,VendorID_Vendor_acctName,SOOrder__OrderNbr,SOOrder__CustomerID,SOOrder__CustomerID_BAccountR_acctName" Caption="Details">
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="POSiteID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="POSiteID_description" Width="108px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="SourceSiteID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="SourceSiteDescr" Width="108px" />
