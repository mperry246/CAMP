	...
	<px:PXDataSource ID="ds" runat="server" Visible="True"
		...
		<CallbackCommands>
			<px:PXDSCallbackCommand Name="actionRefreshProperties" 
				RepaintControls="None" RepaintControlsIDs="PropGridFilter,PropGrid" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="PropGridFilter" runat="server" Width="100%" DataSourceID="ds" DataMember="FilterGridProps"
		...
		<Template>
			...
			<px:PXCheckBox runat="server" ID="ShowAllControls" DataField="ShowAllControls" CommitChanges="True" />
		...
		<Template1>
			...
			<script type="text/javascript">
				...
				function Tree_ButtonClick(tlb, arg)
				{
					...
					{
						case "Filter":
							__px_alls(tlb)["ShowAllControls"].updateValue(!arg.button.getPushed());
							break;
					}
				}
			</script>
			<px:PXTreeView ID="TreePageControls" runat="server" DataSourceID="ds" DataMember="AspxPageControls" 
				...
				Height="100px" ShowRootNode="false" ShowLines="false" DragSources="tab" SyncPosition="true"
				...
				<ToolBarItems>
					...
					<px:PXToolBarButton ImageKey="Remove" CommandName="Delete" />
					<px:PXToolBarButton ImageKey="Filter" Tooltip="Show/Hide All Controls" Key="Filter" ToggleMode="true" />
				</ToolBarItems>
				<CallBackMode RepaintControlsIDs="ds"></CallBackMode>
				<DataBindings>
					<px:PXTreeItemBinding DataMember="AspxPageControls" TextField="Name" ValueField="NodeId" ImageUrlField="NodeImage" />
				</DataBindings>
				<Styles>
		...
		<%--			
					...
					<px:PXTabItem Text="Add Controls">
						<Template>
							...
							<px:PXButton runat="server" ID="btnAddForm" Text="Form" Key="FormView" />
							<px:PXButton runat="server" ID="btnAddTab" Text="Tab" Key="Tab" />
							<px:PXButton runat="server" ID="btnAddTabItem" Text="Tab Item" Key="TabItem" />
							<px:PXButton runat="server" ID="btnAddGrid" Text="Grid" Key="Grid" />
							<px:PXButton runat="server" ID="btnAddPopup" Text="Pop-up Panel" Key="SmartPanel" />

							<px:PXLayoutRule runat="server" ID="rule2" GroupCaption="Layout Rules" />
							<px:PXButton runat="server" ID="btnAddRow" Text="Row" Key="Row" />
							<px:PXButton runat="server" ID="btnAddColumn" Text="Column" Key="Column" />
							<px:PXButton runat="server" ID="btnAddGroup" Text="Group" Key="Group" />
							<px:PXButton runat="server" ID="btnAddMerge" Text="Merge" Key="Merge" />
							<px:PXButton runat="server" ID="btnAddRule" Text="Empty Rule" Key="LayoutRule" />

							<px:PXLayoutRule runat="server" ID="rule3" StartColumn="true" GroupCaption="Other Controls" />
							<px:PXButton runat="server" ID="btnAddPanel" Text="Panel" Key="Panel" />
							<px:PXButton runat="server" ID="btnAddGroupBox" Text="Group Box" Key="GroupBox" />
							<px:PXButton runat="server" ID="btnAddRadioButton" Text="Radio Button" Key="RadioButton" />
							<px:PXButton runat="server" ID="btnAddLabel" Text="Label" Key="Label" />
							<px:PXButton runat="server" ID="btnAddButton" Text="Button" Key="Button" />
							<px:PXButton runat="server" ID="btnAddScript" Text="Java Script" Key="JavaScript" />
						</Template>
					</px:PXTabItem>
