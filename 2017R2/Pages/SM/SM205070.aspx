...
<asp:Content ID="Content2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView runat="server"
		...
		<Template>
			...
			<px:PXTextEdit runat="server" DataField="GCTotalMemory" ID="GCTotalMemory" LabelWidth="135" />
			<px:PXTextEdit runat="server" DataField="WorkingSet" ID="WorkingSet" LabelWidth="135" />
			<px:PXTextEdit runat="server" DataField="PrivateMemory" ID="PrivateMemory" LabelWidth="135" />
			<px:PXTextEdit runat="server" DataField="GCCollection" ID="GCCollection" LabelWidth="135" />
		</Template>
	</px:PXFormView>
