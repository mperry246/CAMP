...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.SM.UploadFileInq">
        ...
        <DataTrees>
            <px:PXTreeDataMember TreeKeys="NodeID" TreeView="Tree" />
        </DataTrees>
    </px:PXDataSource>
</asp:Content>
    ...
    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300">
        ...
        <Template1>
            <px:PXTreeView ID="tree" runat="server" DataSourceID="ds" PopulateOnDemand="True" ShowRootNode="False"
                ExpandDepth="1" AutoRepaint="True" AllowCollapse="False" SelectFirstNode="True">
				<ToolBarItems>
                ...
                <DataBindings>
                    <px:PXTreeItemBinding DataMember="Tree" TextField="Title" ValueField="NodeID" ImageUrlField="Icon" />
                </DataBindings>
            </px:PXTreeView>
        </Template1>
        <Template2>
