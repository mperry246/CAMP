...
<%--				<px:PXCheckBox ID="chkCustomization" runat="server" DataField="Customization" />--%>
	...
	<px:PXSmartPanel ID="pnlCopyCompany" runat="server" CaptionVisible="True" Caption="Copy Company"
		...
		<px:PXFormView ID="frmCopyCompany" runat="server" SkinID="Transparent" DataMember="CopyCompanyPanel"
			...
			<Template>
				...
				<px:PXSelector ID="edCompanyID" runat="server" AutoRefresh="True" 
					DataField="CompanyID" DataSourceID="ds" ReadOnly="True">
				</px:PXSelector>
				<px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons">
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		DataMember="Companies" EmailingGraph="" Caption="Company Summary" TemplateContainer="">
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" LabelsWidth="SM" StartColumn="True" ControlSize="M" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Snapshots">
								<Columns>
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="Size" Label="Size (MB)" Width="145px" />
