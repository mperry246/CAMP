    ...
    <px:PXToolBar ID="toolbar1" runat="server" SkinID="Navigation"
        ...
        <Items>
            <px:PXToolBarButton Text="Synchronization" Tooltip="Synchronization">
                <MenuItems>
                    <px:PXMenuItem CommandName="downloadFile" CommandSourceID="ds" Text="Download File" />
                    <px:PXMenuItem CommandName="uploadFile" CommandSourceID="ds" Text="Upload File" />
                </MenuItems>
            </px:PXToolBarButton>
        </Items>
    </px:PXToolBar>
		...
		<Items>
			...
			<px:PXTabItem Text="Access Rights" RepaintOnDemand="false" Tooltip="Shows access rights for the file."
				...
				<Template>
					...
					<px:PXTreeSelector CommitChanges="True" ID="edScreenID" runat="server" DataField="PrimaryScreenID"
						PopulateOnDemand="True" ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="SiteMap" AutoRefresh="True"
						InitialExpandLevel="0" MinDropWidth="393" >
						<DataBindings>
