                            ...
                            <px:PXFormView ID="entityPropertiesForm" runat="server" DataSourceID="ds" Width="100%" DataMember="SelectedEntity" SkinID="Transparent">
                                <Template>
                                    ...
                                    <px:PXTreeSelector CommitChanges="True" ID="edScreenID" runat="server" DataField="ScreenID"
                                        ...
                                        TreeDataSourceID="ds">
                                        <DataBindings>
                                            <px:PXTreeItemBinding DataMember="SiteMap" ImageUrlField="Icon" TextField="Title" ValueField="ScreenID" ToolTipField="TitleWithPath" />
                                        </DataBindings>
                                    </px:PXTreeSelector>
        ...
        <px:PXFormView ID="formCreateEntity" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" CaptionVisible="False"
            ...
            <Template>
                ...
                <px:PXTreeSelector CommitChanges="True" ID="edScreenID" runat="server" DataField="ScreenID"
                    ...
                    TreeDataSourceID="ds">
                    <DataBindings>
                        <px:PXTreeItemBinding DataMember="SiteMap" ImageUrlField="Icon" TextField="Title" ToolTipField="TitleWithPath"
                            ValueField="ScreenID" />
                    </DataBindings>
                </px:PXTreeSelector>
