			...
			<px:PXTabItem Text="Generic Inquiries">
				<Template>
	                <px:PXGrid ID="grid1" runat="server" DataSourceID="ds" Style="z-index: 100" 
		                Width="100%" Height="150px" SkinID="Details" TabIndex="5700" TemporaryFilterCaption="Filter Applied" AutoAdjustColumns="true" SyncPosition="true">
                        <ActionBar>
                            <CustomItems>
            ...
            <px:PXTabItem Text="Built-In Definitions">
				<Template>
	                <px:PXGrid ID="grid2" runat="server" DataSourceID="ds" Style="z-index: 100" 
		                Width="100%" Height="150px" SkinID="Details" TabIndex="5700" TemporaryFilterCaption="Filter Applied" AutoAdjustColumns="true">
		                <Levels>
