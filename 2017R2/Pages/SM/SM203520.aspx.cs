...
public partial class Page_SM200575 : PXPage
{
	...
	{
		String key = PX.Common.PXUrl.ToAbsoluteUrl(this.Request.Path);
		if(PXContext.Session.PageInfo[key] == null) PXContext.Session.PageInfo[key] = new object[] { PX.Data.Update.PXInstanceHelper.CurrentCompany };
