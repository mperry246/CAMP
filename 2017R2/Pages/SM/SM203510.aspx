	...
	<px:PXSmartPanel ID="pnlLockout" runat="server" CaptionVisible="True" Caption="Schedule Lockout" LoadOnDemand="true" Key="LockoutFilterRecord">
		<px:PXFormView runat="server" ID="frmLockout" DataMember="LockoutFilterRecord" SkinID="Transparent" DataSourceID="ds">
			<Template>
				...
				<px:PXCheckbox ID="chkLockoutAll" runat="server" DataField="LockoutAll" Size="S" />
			</Template>
		</px:PXFormView>
			...
			<px:PXTabItem Text="Update History" Overflow="Hidden">
				<Template>
					<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="500" SkinID="Horizontal" Height="500px" Panel1MinSize="150" Panel2MinSize="150">
						<AutoSize Enabled="true" />
						<Template1>
                            <px:PXSplitContainer runat="server" ID="sp2" SplitterPosition="250" SkinID="Horizontal" Height="300px"  Panel1MinSize="150" Panel2MinSize="150">
						        <AutoSize Enabled="true" />
                                <Template1>
							        <px:PXGrid ID="gridUPHistory" runat="server" AdjustPageSize="Auto" DataSourceID="ds" ActionsPosition="Top" AllowPaging="True"
								        ...
								        <Levels>
									        <px:PXGridLevel DataMember="UpdateHistoryRecords">
										        <Columns>
											        <px:PXGridColumn DataField="UpdateID" Label="Maintenance ID" TextAlign="Right" Width="150px" />
											        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="Host" Label="Host" Width="300px" />
                                ...
                                <Template2>
							        <px:PXGrid ID="gridUPHistoryComponents" runat="server" AdjustPageSize="Auto" DataSourceID="ds" ActionsPosition="Top" AllowPaging="True"
								        SkinID="Inquire" Caption="Update History Components" Width="100%" Height="200px" FeedbackMode="DisableAll">
								        <Levels>
									        <px:PXGridLevel DataMember="UpdateHistoryComponentsRecords">
										        <Columns>
                                                    <px:PXGridColumn DataField="UpdateComponentID" Label="Maintenance Components ID" TextAlign="Right" Width="150px" />
											        <px:PXGridColumn DataField="UpdateID" Label="Maintenance ID" TextAlign="Right" Width="150px" />
                                                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ComponentName" Label="Component Name" Width="100px" />
											        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ComponentType" Label="Component Type" Width="100px" />
											        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="FromVersion" Label="From Version" Width="150px" />
											        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ToVersion" Label="To Version" Width="150px" />
										        </Columns>
									        </px:PXGridLevel>
								        </Levels>
								        <AutoSize Enabled="True" MinHeightLimit="150" MinHeight="150" />
