            ...
            <px:PXTabItem Text="Secrets">
                <Template>
                    <px:PXGrid ID="clientSecrets" runat="server" DataSourceID="ds" Style="z-index: 100"
                        Width="100%" SkinID="DetailsInTab" TemporaryFilterCaption="Filter Applied" AutoAdjustColumns="True" TabIndex="800">
                        <Levels>
            ...
            <px:PXTabItem Text="Redirect URIs">
                <Template>
                    <px:PXGrid ID="redirectUris" runat="server" DataSourceID="ds" Style="z-index: 100"
                        Width="100%" SkinID="DetailsInTab" TemporaryFilterCaption="Filter Applied" AutoAdjustColumns="True">
                        <Levels>
