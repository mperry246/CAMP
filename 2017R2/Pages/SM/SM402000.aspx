<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SM402000.aspx.cs" Inherits="Page_SM401000" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormTab.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SM.MergedDatabaseSchemaInquiry" PageLoadBehavior="GoFirstRecord" PrimaryView="inspectingTables">
		<CallbackCommands>
	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds">
		<Items>
			<px:PXTabItem Text="Incoming References">
				<Template>
					<px:PXGrid runat="server" SkinID="Details" Width="100%" TabIndex="2700" ID="PXGridOut" AdjustPageSize="Auto" AllowPaging="True" TemporaryFilterCaption="Filter Applied" DataSourceID="ds" SyncPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="tableIncomingReferences">
								<RowTemplate>
									...
									<px:PXTextEdit runat="server" DataField="SubstitutableChildren" ID="edApplicableChildIn" ValidateRequestMode="Inherit" Height="200px" TextMode="MultiLine"></px:PXTextEdit>
									<px:PXLayoutRule runat="server" ColumnSpan="2"></px:PXLayoutRule>
									...
									<px:PXTextEdit runat="server" DataField="SubstitutableParents" ID="edApplicableParentsIn" ValidateRequestMode="Inherit" Height="200px" TextMode="MultiLine"></px:PXTextEdit>
								</RowTemplate>
								<Columns>
			...
			<px:PXTabItem Text="Outgoing References">
				<Template>
					<px:PXGrid runat="server" SkinID="Details" Width="100%" TabIndex="2800" ID="PXGridIn" AdjustPageSize="Auto" AllowPaging="True" TemporaryFilterCaption="Filter Applied" DataSourceID="ds" SyncPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="tableOutgoingReferences">
								<RowTemplate>
									...
									<px:PXTextEdit runat="server" DataField="SubstitutableChildren" ID="edApplicableChildOut" ValidateRequestMode="Inherit" Height="200px" TextMode="MultiLine"></px:PXTextEdit>
									<px:PXLayoutRule runat="server" ColumnSpan="2"></px:PXLayoutRule>
									...
									<px:PXTextEdit runat="server" DataField="SubstitutableParents" ID="edApplicableParentsOut" ValidateRequestMode="Inherit" Height="200px" TextMode="MultiLine"></px:PXTextEdit>
								</RowTemplate>
								<Columns>
