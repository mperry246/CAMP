...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INKitSpecMaint" PrimaryView="Hdr">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="frmHeader" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Hdr" Caption="Kit Specification Summary"
        ...
        <Template>
            ...
            <px:PXSelector ID="edKitInventoryID" runat="server" DataField="KitInventoryID" AutoRefresh="True" AllowEdit="True">
            ...
            <px:PXTabItem Text="Stock Components">
                <Template>
                    <px:PXGrid ID="gridStock" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" ActionsPosition="Top"
                        TabIndex="200" SkinID="Details" BorderStyle="None">
                        <Levels>
                            <px:PXGridLevel DataMember="StockDet">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edSDisassemblyCoeff" runat="server" AllowNull="True" DataField="DisassemblyCoeff" Decimals="6" ValueType="Decimal"
                                        Width="108px" />
                                    <px:PXSelector ID="edUOM" runat="server" DataField="UOM" Width="63px" AllowEdit="True">
                                        <GridProperties>
                                            <PagerSettings Mode="NextPrevFirstLast" />
                                        </GridProperties>
                                    </px:PXSelector>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="NonStockDet">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edUOM2" runat="server" DataField="UOM" Width="63px" AllowEdit="True">
                                        <GridProperties>
                                            <PagerSettings Mode="NextPrevFirstLast" />
                                        </GridProperties>
                                    </px:PXSelector>
