...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds"
		...
		<Template>
            ...
            <px:PXSelector Size="xs" ID="edFinPeriodID" runat="server" DataField="FinPeriodID"  />
	...
	BatchUpdate="true" AllowPaging="true" AdjustPageSize="Auto" TabIndex="100" 
	    ...
	    <Levels>
			<px:PXGridLevel DataMember="INItemList" >
				...
				<Columns>
					<px:PXGridColumn AllowNull="False" DataField="Selected" AllowCheckAll="True" TextAlign="Center" Type="CheckBox" Width="30px" />
					<px:PXGridColumn AllowUpdate="False" DataField="InventoryCD" DisplayFormat="&gt;AAA-&gt;CCC-&gt;AA" Width="90px" />
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="INSiteStatusSummary__QtyOnHand" NullText="0.0" TextAlign="Right" Width="100px" />
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="INSiteStatusSummary__QtyAvail" NullText="0.0" TextAlign="Right" Width="100px" />
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="INSiteStatusSummary__QtyNotAvail" NullText="0.0" TextAlign="Right" Width="120px" />										
				</Columns>
			</px:PXGridLevel>
		</Levels>
