...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INItemSiteMaint" PrimaryView="itemsiterecord">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="itemsiterecord" Caption="Item/Warehouse Summary"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
            <px:PXTreeSelector ID="edProductWorkgroupID" runat="server" DataField="ProductWorkgroupID" TreeDataMember="_EPCompanyTree_Tree_"
            ...
            <px:PXSelector ID="edProductManagerID" runat="server" DataField="ProductManagerID" AllowEdit="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
        ...
        <Items>
            <px:PXTabItem Text="General Settings" RepaintOnDemand="false">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edInvtAcctID" runat="server" DataField="InvtAcctID" AllowEdit="True" />
