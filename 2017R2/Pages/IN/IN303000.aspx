...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INAdjustmentEntry" PrimaryView="adjustment">
        <CallbackCommands>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="SubItemID" Width="45px" NullText="<SPLIT>" AutoCallBack="true" />
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="Qty" TextAlign="Right" Width="108px" AutoCallBack="true" />
                                    ...
                                    <px:PXGridColumn DataField="OrigRefNbr" Width="81px" AutoCallBack="true" />
