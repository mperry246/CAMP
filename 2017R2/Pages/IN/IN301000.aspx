...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INReceiptEntry" PrimaryView="receipt">
        <CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
								...
								<px:PXGridLevel DataMember="transactions">
									...
									<Columns>
										...
										<px:PXGridColumn AutoCallBack="True" DataField="ProjectID" DisplayFormat="CCCCCCCCCC" Label="Project"
											Width="81px" />
										<px:PXGridColumn DataField="TaskID" DisplayFormat="CCCCCCCCCC" Label="Task" Width="81px" CommitChanges="true" />
										<px:PXGridColumn DataField="TranDesc" Width="351px" />
										<px:PXGridColumn DataField="POReceiptNbr" Width="100px" Visible="False" />
									</Columns>
								</px:PXGridLevel>
							</Levels>
						</px:PXGrid>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="764px" Caption="Allocations" DesignView="Content" CaptionVisible="True"
        Key="lsselect" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True" AutoCallBack-Target="optform" Height="300px">
        ...
        <px:PXGrid ID="grid2" runat="server" Width="100%" AutoAdjustColumns="True" DataSourceID="ds" Height="150px" SyncPosition="true">
    ...
    <px:PXSmartPanel id="PanelAddSiteStatus" runat="server" key="sitestatus" loadondemand="true" width="900px" height="500px"
		...
		<px:PXFormView ID="formSitesStatus" runat="server" CaptionVisible="False" DataMember="sitestatusfilter"
			...
			<Template>
                ...
                <px:PXSegmentMask ID="edSiteID" runat="server" DataField="SiteID" DataSourceID="ds" CommitChanges="True" />
