        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;CCCCCCCCCCCCCCCCCCCCCCCCCCCCCC" Width="144px" AllowUpdate="False" LinkCommand="viewInventoryItem" />
                    <px:PXGridColumn DataField="Descr" Width="200px" AllowUpdate="False" />
                    <px:PXGridColumn AllowUpdate="False" DataField="SubItemID" DisplayFormat="&gt;C" Width="45px" />
                    <px:PXGridColumn DataField="QtyProcess" Width="100px" AllowUpdate="False" AllowNull="False" TextAlign="Right" AutoCallBack="true" />
                    <px:PXGridColumn DataField="QtyINReplaned" Width="100px" AllowUpdate="False" AllowNull="False" TextAlign="Right" />
                    <px:PXGridColumn DataField="QtyOnHand" Width="100px" AllowUpdate="False" AllowNull="False" TextAlign="Right" />
                    <px:PXGridColumn DataField="QtyReplenishment" Width="100px" AllowUpdate="False" TextAlign="Right" />
					<px:PXGridColumn DataField="QtyDemand" Width="100px" AllowUpdate="False" TextAlign="Right" />
                    <px:PXGridColumn DataField="QtyHardDemand" Width="100px" AllowUpdate="False" TextAlign="Right" />
                    <px:PXGridColumn DataField="SafetyStock" Width="100px" AllowUpdate="False" TextAlign="Right" />
                    <px:PXGridColumn DataField="MinQty" AllowUpdate="False" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="MaxQty" AllowUpdate="False" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="ReplenishmentSource" AllowUpdate="False" Width="100px" AutoCallBack="true" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="PreferredVendorName" Width="200px" />
                    ...
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="QtyPOPrepared" Label="Qty. PO Prepared" TextAlign="Right"
                        Width="100px" />
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="QtyPOOrders" Label="Qty. PO Orders" TextAlign="Right" Width="100px" />
                    ...
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="QtySOPrepared" Label="Qty. SO Prepared" TextAlign="Right"
                        Width="100px" />
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="QtySOBooked" Label="Qty. SO Booked" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="QtySOShipped" Label="Qty. SO Shipped" TextAlign="Right"
                        Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="QtySOShipping" Label="Qty. SO Shipping" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="QtyINIssues" Label="Qty. IN Issues" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="QtyINAssemblyDemand" Label="Qty. IN Assembly Demand" TextAlign="Right" Width="100px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
