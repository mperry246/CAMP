...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <table style="width: 100%;" cellspacing="0" border="0" cellpadding="0">
        <tr>
            <td>
                <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="PIHeader" TypeName="PX.Objects.IN.INPIReview"
                    PageLoadBehavior="GoLastRecord">
                    <CallbackCommands>
                        <px:PXDSCallbackCommand CommitChanges="True" Name="Save" />
                        <px:PXDSCallbackCommand Name="FinishCounting" CommitChanges="True" StartNewGroup="True" />
                        <px:PXDSCallbackCommand Name="CancelPI" CommitChanges="True" />
                        <px:PXDSCallbackCommand Name="CompletePI" CommitChanges="True" RepaintControls="All" />
                        <px:PXDSCallbackCommand Name="UpdateCost" Visible="False" />
                        <px:PXDSCallbackCommand Name="SetNotEnteredToZero" Visible="False" />
                        <px:PXDSCallbackCommand Name="SetNotEnteredToSkipped" Visible="False" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <script type="text/javascript">
        function PanelAdd_Load() {
            PXCallback.addHandler(_addLineHhandleCallback);
    ...
    <px:PXSmartPanel ID="PanelAddRL" runat="server" Style="z-index: 108;" Width="868px" Key="AddByBarCode" Caption="Add Line"
        ...
        <px:PXFormView ID="frmBarCode" runat="server" DataSourceID="ds" Height="173px" Style="z-index: 100" Width="100%" DataMember="AddByBarCode"
            ...
            <Template>
                ...
                <audio id="audioDing" preload="auto" src="../../Sounds/Ding.wav" style="visibility: hidden">
                </audio>
                ...
                <px:PXSegmentMask ID="edSubItemIDPnl" runat="server" CommitChanges="True" DataField="SubItemID" />
                    ...
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" BorderWidth="0px" SkinID="DetailsInTab" Style="height: 240px;"
                        ...
                        <ActionBar>
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Key="UpdateCost" Text="Update Actual Cost">
                                    <AutoCallBack Command="UpdateCost" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="SetNotEnteredToZero" Text="Set Not Entered To Zero">
                                    <AutoCallBack Command="SetNotEnteredToZero" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="SetNotEnteredToSkipped" Text="Set Not Entered To Skipped">
                                    <AutoCallBack Command="SetNotEnteredToSkipped" Target="ds" />
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                        <Levels>
                            <px:PXGridLevel DataMember="PIDetail">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="InventoryID_InventoryItem_descr" Width="108px" />
                                    <px:PXGridColumn DataField="SubItemID" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="LocationID" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="LotSerialNbr" Width="120px" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="ExpireDate" Label="Expiry Date" Width="90px" />
                                    <px:PXGridColumn DataField="BookQty" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="PhysicalQty" TextAlign="Right" Width="100px" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="VarQty" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="UnitCost" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="ExtVarCost" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="ReasonCode" Width="100px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
