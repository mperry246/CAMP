...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INTransferEntry" PrimaryView="transfer">
        <CallbackCommands>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="LocationID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" NullText="<SPLIT>" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="ToLocationID" DisplayFormat="&gt;AAAAAAAAAA" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="ReceiptedQty" TextAlign="Right" Width="108px" />
                                    <px:PXGridColumn DataField="INTransitQty" TextAlign="Right" Width="108px" />
                                    <px:PXGridColumn DataField="LotSerialNbr" Width="180px" NullText="<SPLIT>" AutoCallBack="true" />
                ...
                <Template>
                    <px:PXFormView ID="form2" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="CurrentDocument"
                        ...
                        <Template>
                            ...
                            <px:PXSegmentMask CommitChanges="True" ID="edBranchID" runat="server" DataField="BranchID" /></Template>
