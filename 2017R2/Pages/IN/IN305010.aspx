        ...
        <Levels>
            <px:PXGridLevel DataMember="PIDetail">
                <Columns>
                    ...
                    <px:PXGridColumn AllowNull="False" DataField="BookQty" TextAlign="Right" Width="100px" AllowUpdate="False" />
                    <px:PXGridColumn DataField="PhysicalQty" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="VarQty" TextAlign="Right" Width="100px" AllowUpdate="False" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
