...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.KitAssemblyEntry" PrimaryView="Document">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Kit Summary" DataMember="Document"
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" runat="server" DataField="SubItemID" ID="edSubItemID" />
                    ...
                    <px:PXGrid runat="server" ID="componentsGrid" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Components" DataKeyNames="DocType,RefNbr,LineNbr">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="DocType" Width="81px" Visible="False" AllowShowHide="False" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;AAAAAAAAAAAAAAAAAAAAAAAAA" Width="171px" 
                                        AutoCallBack="True" />
                                    <px:PXGridColumn DataField="SubItemID" DisplayFormat="&gt;AA-A-&gt;AA" Width="63px" />
                                    <px:PXGridColumn DataField="LocationID" DisplayFormat="&gt;CCCCCC-CCCC" Width="81px" AutoCallBack="True" />
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="INKitSpecStkDet__DfltCompQty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecStkDet__UOM" DisplayFormat="&gt;aaaaaa" Width="63px" />
                                    <px:PXGridColumn AllowNull="False" DataField="INKitSpecStkDet__AllowQtyVariation" TextAlign="Center" Type="CheckBox" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecStkDet__MinCompQty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecStkDet__MaxCompQty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecStkDet__DisassemblyCoeff" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn AllowNull="False" DataField="INKitSpecStkDet__AllowSubstitution" TextAlign="Center" Type="CheckBox" Width="90px" />
                                </Columns>
                    ...
                    <px:PXGrid runat="server" ID="overheadGrid" DataSourceID="ds" BorderStyle="None" Width="100%" SkinID="Details">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Overhead" DataKeyNames="DocType,RefNbr,LineNbr">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;AAAAAAAAAAAAAAAAAAAAAAAAA" Width="171px" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="UOM" DisplayFormat="&gt;aaaaaa" Width="63px" AutoCallBack="True" />
                                    <px:PXGridColumn AllowNull="False" DataField="Qty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn AllowNull="False" DataField="UnitCost" TextAlign="Right" Width="100px" />
                                    <px:PXGridColumn DataField="ReasonCode" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" />
                                    <px:PXGridColumn AllowNull="False" DataField="INKitSpecNonStkDet__DfltCompQty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecNonStkDet__UOM" DisplayFormat="&gt;aaaaaa" Width="63px" />
                                    <px:PXGridColumn AllowNull="False" DataField="INKitSpecNonStkDet__AllowQtyVariation" TextAlign="Center" Type="CheckBox" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecNonStkDet__MinCompQty" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="INKitSpecNonStkDet__MaxCompQty" TextAlign="Right" Width="90px" />
                                </Columns>
                                <Layout FormViewHeight="" />
                            </px:PXGridLevel>
                        </Levels>
