        ...
        <Items>
            <px:PXTabItem Text="General Info">
                <Template>
                    ...
                    <px:PXTextEdit ID="edSalutation" runat="server" DataField="Contact__Salutation" ></px:PXTextEdit>
                    ...
                    <px:PXSelector ID="edCPriceClassID2" runat="server" DataField="CPriceClassID2" ></px:PXSelector>
                    <px:PXFormView ID="PricesClass2" runat="server" 
                    Caption="Price Class" DataMember="PriceClass2" 
                    DataSourceID="ds" RenderStyle="Simple" TabIndex="1500" DefaultControlID="edlocationID">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" ></px:PXLayoutRule>
                            <px:PXTextEdit ID="edCPriceClassDesc2" runat="server" DataField="Description" ></px:PXTextEdit>
                        </Template>
                    </px:PXFormView>
                    <px:PXSelector ID="edCPriceClassID3" runat="server" DataField="CPriceClassID3" ></px:PXSelector>
                    <px:PXFormView ID="PricesClass3" runat="server" 
                    Caption="Price Class" DataMember="PriceClass3" 
                    DataSourceID="ds" RenderStyle="Simple" TabIndex="1500" DefaultControlID="edlocationID">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" ></px:PXLayoutRule>
                            <px:PXTextEdit ID="edCPriceClassDesc3" runat="server" DataField="Description" ></px:PXTextEdit>
                        </Template>
                    </px:PXFormView>
            ...
            <px:PXTabItem Text="Route Contracts">
                <Template>
                    <px:PXGrid ID="PXRoute" runat="server" DataSourceID="ds" Height="100%" SkinID="Inquire" TabIndex="28872" AutoAdjustColumns="True"
            ...
            <px:PXTabItem Text="Pickup/Delivery Items">
                <Template>
                    <px:PXGrid ID="PXPickUpDeliveryItems" runat="server" DataSourceID="ds" Height="100%" SkinID="Inquire" TabIndex="4900" AutoAdjustColumns="True"
                        Width="100%" NoteIndicator="False" FilesIndicator="False" SyncPosition="True">
                        <Levels>
                            <px:PXGridLevel 
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edServiceID2" runat="server" AutoRefresh="True" DataField="ServiceID">
                                    </px:PXSegmentMask>
                                    <px:PXSegmentMask ID="edInventoryID2" runat="server" DataField="InventoryID">
                                    </px:PXSegmentMask>
                                    <px:PXDropDown ID="edFSAppointmentDet__ServiceType" runat="server" DataField="FSAppointmentDet__ServiceType" Size="SM">
                                    </px:PXDropDown>
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="FSAppointment__RefNbr" Width="120px"  LinkCommand="OpenAppointmentByPickUpDeliveryItem">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSAppointment__ExecutionDate" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSAppointment__Status" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="SODetID" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ServiceID" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSAppointmentDet__ServiceType" Width="200px">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="UnitPrice" TextAlign="Right" Width="120px">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="FSPostDet__Mem_PostedIn" Width="50px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSPostDet__Mem_DocType" Width="50px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSPostDet__Mem_DocNbr" Width="100px" LinkCommand="OpenDocumentByPickUpDeliveryItem">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
            ...
            <px:PXTabItem Text="Service">
                <Template>
                    <px:PXGrid ID="PXGridFSAppointemntDetServices" runat="server" DataSourceID="ds" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Services" DataKeyNames="AppointmentID,AppDetID,SODetID">
                                <RowTemplate>
                                    ...
                                    <px:PXDropDown ID="Status" runat="server" DataField="Status"></px:PXDropDown>                                    
                                    <px:PXDropDown ID="edLineType" runat="server" DataField="LineType"></px:PXDropDown>
                                    <px:PXSegmentMask ID="edServiceID" runat="server" DataField="ServiceID"></px:PXSegmentMask>
                                    ...
                                    <px:PXDateTimeEdit ID="edActualDateTimeBegin_Time2" runat="server" DataField="ActualDateTimeBegin_Time" TimeMode="True"/>
                                    <px:PXDateTimeEdit ID="edActualDateTimeEnd_Time2" runat="server" DataField="ActualDateTimeEnd_Time" TimeMode="True" />
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="FSAppointment__RefNbr" Width="85px" LinkCommand="OpenAppointmentByService">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSAppointment__ExecutionDate" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSAppointment__Status" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="SODetID" Width="85px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status">
                                    </px:PXGridColumn>                                    
                                    <px:PXGridColumn DataField="LineType" Width="100px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ServiceID" Width="100px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSSODet__BillingRule" Width="100px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="TranDesc" Width="200px">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="ActualDateTimeBegin_Time" Width="80px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ActualDateTimeEnd_Time" Width="80px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ActualDuration" Width="95px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Qty" TextAlign="Right" Width="70px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="UnitPrice" Width="100px" TextAlign="Right">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="FSPostDet__Mem_DocNbr" Width="100px" LinkCommand="OpenDocumentByService">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
