    ...
    <%@ MasterType VirtualPath="~/MasterPages/FormView.master" %>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
            <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="BillingCycleRecords" 
                ...
                <Template>
                    <px:PXLayoutRule runat="server" LabelsWidth="S" StartColumn="True"></px:PXLayoutRule>
                    <px:PXLayoutRule runat="server" Merge="True"></px:PXLayoutRule>
                    <px:PXSelector ID="edBillingCycleCD" runat="server" DataField="BillingCycleCD" Size="SM"></px:PXSelector>
                    <px:PXCheckBox ID="edInvoiceOnlyCompletedServiceOrder" runat="server" AlignLeft="True" DataField="InvoiceOnlyCompletedServiceOrder"
                    Text="Invoice only completed Service Orders"></px:PXCheckBox>
                    ...
                    <px:PXGroupBox ID="edBillingBy" runat="server" Caption="Generate Invoices From" CommitChanges="True" DataField="BillingBy">
                        <Template>
                    ...
                    <px:PXLayoutRule runat="server"></px:PXLayoutRule>
                    <px:PXGroupBox ID="edBillingCycleType" runat="server" Caption="Group Invoices By" CommitChanges="True" DataField="BillingCycleType">
                        <Template>
                            ...
                            <px:PXRadioButton ID="edBillingCycleType_op2" runat="server" Text="Work Order" Value="WO" GroupName="edBillingCycleType"/>
                            <px:PXRadioButton ID="edBillingCycleType_op3" runat="server" Text="Purchase Order" Value="PO" GroupName="edBillingCycleType"/>
                    ...
                    <px:PXLayoutRule runat="server" EndGroup="True"></px:PXLayoutRule>
                    <px:PXCheckBox ID="edGroupBillByLocations" runat="server" DataField="GroupBillByLocations" 
                        Text="Break by Billing Customer Location" AlignLeft="True">
                    </px:PXCheckBox>
                </Template>
