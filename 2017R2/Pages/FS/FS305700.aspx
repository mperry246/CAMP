...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ServiceContractRecords" 
		...
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="OpenScheduleScreen" Visible="False"></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="OpenScheduleScreenByScheduleDetService" Visible="False"></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="OpenScheduleScreenByScheduleDetPart" Visible="False"></px:PXDSCallbackCommand>
        </CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        DataMember="ServiceContractRecords" DefaultControlID="edCustomerID" AllowCollapse="True">
        <Template>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Price Settings" StartGroup="True">
            </px:PXLayoutRule>
                    ...
                    <px:PXGrid ID="PXGridScheduleServices" runat="server" AutoAdjustColumns="True" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="FSSchedule__RefNbr" 
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="FSSchedule__RefNbr" LinkCommand="OpenScheduleScreenByScheduleDetService">
                                    </px:PXGridColumn>
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="SalesPriceID,InventoryItem__InventoryCD" DataMember="SalesPricesServices">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Mem_UnitPrice" TextAlign="Right" Width="100px">
                                    </px:PXGridColumn>
                    ...
                    <px:PXGrid ID="PXGridScheduleParts" runat="server" AutoAdjustColumns="True" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="FSSchedule__RefNbr" 
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="FSSchedule__RefNbr" LinkCommand="OpenScheduleScreenByScheduleDetPart">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="LineType">
                                    </px:PXGridColumn>                                    
                                    <px:PXGridColumn DataField="InventoryID">
