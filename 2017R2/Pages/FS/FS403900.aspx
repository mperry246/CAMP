...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Caption="Selection"
		Width="100%" Height="90px" DataMember="Filter" TabIndex="3700" DefaultControlID="edFromDate">
        <Template>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" 
		...
		<Levels>
			<px:PXGridLevel DataMember="Routes" DataKeyNames="RefNbr">
			    ...
			    <Columns>
                    <px:PXGridColumn DataField="RefNbr" LinkCommand="OpenRouteDocument" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="RouteID" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="FSRoute__RouteShort" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="TripNbr" Width="50px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Status">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Date" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="TimeBegin_Time" Width="100px" TimeMode="True">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="TimeEnd_Time" Width="100px" TimeMode="True">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="DriverID" Width="120px" CommitChanges="true" DisplayMode="Hint">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="AdditionalDriverID" Width="120px" CommitChanges="true" DisplayMode="Hint">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="TotalNumAppointments" Width="100px" TextAlign="Right">
                    </px:PXGridColumn>
