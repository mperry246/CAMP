...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Height="230px" FilesIndicator="true" 
		...
		<Template>
            ...
            <px:PXLayoutRule runat="server" ControlSize="SM" StartColumn="True" LabelsWidth="SM">
            </px:PXLayoutRule>
            ...
            <px:PXTextEdit ID="edDescr" runat="server" DataField="Descr" Width="495px">
            </px:PXTextEdit>
            <px:PXLabel runat="server" Height="10px"></px:PXLabel>
            <px:PXLayoutRule runat="server" StartRow="True">
            </px:PXLayoutRule>
            <px:PXLayoutRule runat="server" ColumnWidth="282px" StartColumn="True" GroupCaption="Start Location">
            </px:PXLayoutRule>
            ...
            <px:PXLayoutRule  runat="server" ColumnWidth="282px" StartColumn="True" GroupCaption="End Location">
            </px:PXLayoutRule>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab runat="server" Height="150px" Style="z-index: 100" Width="100%" DataMember="RouteSelected" DataSourceID="ds">
        ...
        <Items>
            <px:PXTabItem Text="Execution Days">
                ...
                <px:PXLabel runat="server">Nbr. Trip(s) per Day</px:PXLabel>
                    ...
                    <px:PXGrid ID="PXRouteEmployees" runat="server" DataSourceID="ds" SkinID="Details" Width="100%"  
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="RouteID,EmployeeID" DataMember="RouteEmployeeRecords">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="EmployeeID" Width="150px" CommitChanges="True">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="BAccount__AcctName" Width="200px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="BAccount__Status">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="PriorityPreference" Width="150px">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
