    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="348px" DataSourceID="ds" DataMember="SetupRecord"
        ...
        <px:PXTabItem Text="General Settings">
		    <Template>
                ...
                <px:PXLayoutRule runat="server" GroupCaption="Calendar Board Settings" StartGroup="True">
                </px:PXLayoutRule>
                ...
                <px:PXLayoutRule runat="server" Merge="True" ControlSize="XXS" LabelsWidth="M" ></px:PXLayoutRule>
                ...
                ID="edDfltCalendarStartTime_Time" CommitChanges="True">
                </px:PXDateTimeEdit>
                <px:PXCheckBox ID="edTrackAppointmentLocation" runat="server" AlignLeft="True" DataField="TrackAppointmentLocation">
                </px:PXCheckBox>
                <px:PXLayoutRule runat="server" EndGroup="True">
                </px:PXLayoutRule>
                <px:PXLayoutRule runat="server" GroupCaption="Calendar Board Custom Naming" StartGroup="True">
                </px:PXLayoutRule>
