...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" 
		Width="100%" Height="130px" DataMember="Filter" TabIndex="3700">
        <Template>
            <px:PXLayoutRule runat="server" ControlSize="SM" StartColumn="True" StartRow="True">
            </px:PXLayoutRule>
            ...
            <px:PXLayoutRule runat="server" GroupCaption="Status" StartColumn="True" StartGroup="True" SuppressLabel="True">
            </px:PXLayoutRule>
		...
		<Levels>
			<px:PXGridLevel DataMember="RouteDocuments" DataKeyNames="RefNbr">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="TimeBegin_Time" Width="90px">
                    </px:PXGridColumn>
