...
Inherits="Page_FS304010" Title="Untitled Page" %>
    <%@ MasterType VirtualPath="~/MasterPages/FormTab.master" %>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
            <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="140px" DataMember="RouteRecords"
                 NoteIndicator="False" FilesIndicator="False" TabIndex="3700" DefaultControlID="edRefNbr">
                <Template>
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="AppointmentsInRoute" DataKeyNames="SrvOrdType,RefNbr">
                                    ...
                                    <Columns>
                                        ...
                                        <px:PXGridColumn DataField="ServiceContractID" Width="90px" LinkCommand="OpenRouteContract"></px:PXGridColumn>
                                        ...
                                        <px:PXGridColumn DataField="FSServiceOrder__CustomerID" Width="150px" DisplayMode="Hint"></px:PXGridColumn>
                                        <px:PXGridColumn DataField="FSServiceOrder__LocationID" Width="75px" LinkCommand="OpenCustomerLocation"></px:PXGridColumn>
                                        ...
                                        <px:PXGridColumn DataField="FSServiceOrder__AddressLine1" Width="150px"></px:PXGridColumn>
                                        <px:PXGridColumn DataField="FSServiceOrder__AddressLine2" Width="120px"></px:PXGridColumn>
                                        <px:PXGridColumn DataField="FSServiceOrder__City" Width="150px"></px:PXGridColumn>
                                        <px:PXGridColumn DataField="FSServiceOrder__State" Width="50px"></px:PXGridColumn>
                                        <px:PXGridColumn DataField="FSServiceOrder__PostalCode" Width="80px"></px:PXGridColumn>
                                    </Columns>
                                </px:PXGridLevel>
                            </Levels>
