...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="RouteAppointmentForecastingFilter" Width="100%" Height="70px" AllowAutoHide="false">
        <Template>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Details" AllowAutoHide="false" AllowPaging="True" AdjustPageSize="Auto" AutoAdjustColumns="True" SyncPosition="True" KeepPosition="True">
        <Levels>
            <px:PXGridLevel 
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RouteID" Width="100px" DisplayMode="Hint">
                    </px:PXGridColumn>                                    
					<px:PXGridColumn DataField="FSSchedule__RefNbr" LinkCommand="OpenScheduleScreen">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="ServiceContractID" Width="100px" LinkCommand="OpenServiceContractScreen"> 
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustomerID" Width="100px" DisplayMode="Hint">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustomerLocationID" Width="100px" DisplayMode="Hint" LinkCommand="OpenLocationScreen">
                    </px:PXGridColumn>
                </Columns>
            </px:PXGridLevel>
        </Levels>
