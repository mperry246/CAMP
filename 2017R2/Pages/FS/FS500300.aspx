<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="FS500300.aspx.cs" Inherits="Page_FS500200" Title="Untitled Page" %>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
		Width="100%" Height="160px" DataMember="Filter" TabIndex="1300" DefaultControlID="edCustomerID">
        <Template>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="100%" DataSourceID="ds" 
        DataMember="ServiceContractSchedules">
		<Items>
            <px:PXTabItem Text="Schedules">
                <Template>
                    <px:PXGrid ID="gridServiceContracts" runat="server" AllowPaging="True" 
		                ...
		                <Levels>
			                <px:PXGridLevel DataMember="ServiceContractSchedules" DataKeyNames="CustomerID,RefNbr">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="FSServiceContract__BranchID" Width="130px">
                                    </px:PXGridColumn>        
                                    <px:PXGridColumn DataField="FSServiceContract__BranchLocationID" Width="130px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="CustomerID" Width="150px" 
                                        TextField="CustomerID_description" >
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSServiceContract__CustomerLocationID" Width="130px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="FSServiceContract__RefNbr" Width="140px" 
                                    ...
                                    <px:PXGridColumn DataField="CustomerLocationID" Width="120px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="RecurrenceDescription" Width="200px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ScheduleGenType" Width="180px">
                                    </px:PXGridColumn>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ErrorMessageRecords" DataKeyNames="LogID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="FSServiceContract__CustomerID" Width="120px">
                                    </px:PXGridColumn>
