...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
		Width="100%" Height="75px" DataMember="GeoZoneRecords" TabIndex="7900" DefaultControlID="GeoZoneCD">
        <Template>
            <px:PXLayoutRule runat="server" StartRow="True">
            </px:PXLayoutRule>
            <px:PXSelector runat="server" DataField="GeoZoneCD" DataSourceID="ds" 
                ID="GeoZoneCD" Size="M" AutoRefresh="True" LabelWidth="130px">
            </px:PXSelector>
            <px:PXTextEdit runat="server" DataField="Descr" ID="Descr" Size="L" LabelWidth="130px">
            </px:PXTextEdit>
        </Template>
	</px:PXFormView>
</asp:Content>
                    ...
                    <px:PXGrid ID="PXGrid1" runat="server" TabIndex="4900" DataSourceID="ds" 
                        ...
                        <Levels>
                            <px:PXGridLevel 
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="EmployeeID" TextAlign="Left" Width="150px" AutoCallBack = "True">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="EmployeeID_EPEmployee_acctName" Width="200px">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                    ...
                    <px:PXGrid ID="PXGrid2" runat="server" DataSourceID="ds" SkinID="DetailsInTab" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="GeoZoneID,PostalCode" 
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="PostalCode" Width="190px" CommitChanges="True">
                                    </px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
