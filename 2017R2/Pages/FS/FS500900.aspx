...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" 
        ...
        <Template>
            <px:PXLayoutRule runat="Server" StartRow="True" ColumnWidth="XM"></px:PXLayoutRule>
        ...
        <Levels>
            <px:PXGridLevel DataMember="InventoryItems">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="Descr" Width="150px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="LotSerialNumber" Width="120px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="ItemClassID" Width="120px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="InvoiceRefNbr" Width="120px"  LinkCommand="OpenInvoice">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="DocDate" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustomerID" Width="120px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CustomerLocationID" Width="140px">
                    </px:PXGridColumn>
                </Columns>
		    </px:PXGridLevel>
        </Levels>
