<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" 
    ...
    <%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	            <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="RouteAppointmentGPSLocationFilter" Width="100%" Height="100px" AllowAutoHide="False">
		        <Template>
        ...
        <asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
			 <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" 
				 Width="100%" Height="150px" SkinID="Inquire" AllowPaging="True" AdjustPageSize="Auto" SyncPosition="True" KeepPosition="True">
				 <Levels>
					 <px:PXGridLevel DataMember="RouteAppointmentGPSLocationRecords">
						...
						<Columns>
							<px:PXGridColumn DataField="RouteID" Width="90px" DisplayMode="Hint"/>
							<px:PXGridColumn DataField="RouteDocumentID" Width="90px"/>
							<px:PXGridColumn DataField="RefNbr" Width="90px" LinkCommand="EditDetail"/>
							<px:PXGridColumn DataField="CustomerID" Width="90px" DisplayMode="Hint"/>
							<px:PXGridColumn DataField="LocationID" Width="100px" DisplayMode="Hint" LinkCommand="OpenLocationScreen"/>
							<px:PXGridColumn DataField="ActualDateTimeBegin" Width="90px" />
							<px:PXGridColumn DataField="Address" Width="200px" />
							<px:PXGridColumn DataField="GPSStartCoordinate" Width="170px" />
							<px:PXGridColumn DataField="GPSStartAddress" Width="280px" />
							<px:PXGridColumn DataField="GPSCompleteCoordinate" Width="160px" />
							<px:PXGridColumn DataField="GPSCompleteAddress" Width="280px" />
						</Columns>
					 </px:PXGridLevel>
				 </Levels>
