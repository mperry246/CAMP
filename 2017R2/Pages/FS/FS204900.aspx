...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="100%" DataSourceID="ds" 
        DataMember="ServiceTemplateDetServices" Style="z-index: 100">
        <Items>
                   ...
                   <px:PXGrid ID="PXGridService" runat="server" AutoAdjustColumns="True" 
		                ...
		                <Levels>
			                <px:PXGridLevel DataKeyNames="ServiceTemplateID,ServiceTemplateDetID" 
                                DataMember="ServiceTemplateDetServices">
			                    <RowTemplate>
            ...
            <px:PXTabItem Text="Inventory Items">
                <Template>
                   <px:PXGrid ID="PXGridPart" runat="server" AutoAdjustColumns="True" 
                        DataSourceID="ds" Height="530px" SkinID="Details" TabIndex="4200" Width="100%">
		                <Levels>
			                <px:PXGridLevel DataKeyNames="ServiceTemplateID,ServiceTemplateDetID" 
                                DataMember="ServiceTemplateDetParts">
			                    <RowTemplate>
