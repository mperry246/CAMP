...
<asp:Content ID="Content1" ContentPlaceHolderID="phF" runat="Server">
   <px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Selection" DataMember="Filter" NoteField="" AllowCollapse="True" TabIndex="100">
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
            <px:PXDateTimeEdit runat="server" DataSourceID="ds" ID="edFromScheduledDate" DataField="FromScheduledDate" CommitChanges="True" />
            <px:PXDateTimeEdit runat="server" DataSourceID="ds" ID="edToScheduledDate" DataField="ToScheduledDate" CommitChanges="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
