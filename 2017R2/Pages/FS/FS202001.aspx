...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" FilesIndicator="True"
		Width="100%" Height="280px" DataMember="StaffScheduleRecords" TabIndex="4500" MarkRequired="Dynamic">
        <Template>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="170px" DataSourceID="ds" DataMember="StaffScheduleSelected">
		<Items>
			<px:PXTabItem Text="Recurrence">
			    <Template>
                    ...
                    <px:PXGroupBox ID="edFrequencyType" runat="server" Caption="Frequency Settings" 
                        ...
                        <Template>
                            ...
                            <px:PXRadioButton ID="edFrequencyType_op3" runat="server" 
                                GroupName="edFrequencyType" Text="Annual" Value="A" />
                        </Template>
                    ...
                    <px:PXLayoutRule runat="server" StartRow = "True" StartGroup="True" StartColumn="True" GroupCaption="Annual Settings"></px:PXLayoutRule>
