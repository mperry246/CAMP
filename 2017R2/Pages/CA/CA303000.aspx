    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top" Caption="Cash Transactions" AllowPaging="true" AdjustPageSize="Auto" SkinID="Details">
        ...
        <Levels>
            <px:PXGridLevel DataMember="CATranListRecords">
                ...
                <Columns>
                    <px:PXGridColumn AllowCheckAll="True" DataField="Selected" RenderEditorText="True" TextAlign="Center" Type="CheckBox" Width="30px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="TranDate" Width="70px" />
                    <px:PXGridColumn DataField="FinPeriodID" Width="70px" />
                    <px:PXGridColumn DataField="DayDesc" Width="80px" />
                    <px:PXGridColumn DataField="OrigModule" Width="50px" />
                    ...
                    <px:PXGridColumn DataField="BatchNbr" Width="80px" LinkCommand="ViewBatch" />
                    <px:PXGridColumn DataField="Status" Type="DropDownList" Width="50px" />
                    ...
                    <px:PXGridColumn DataField="EndBal" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="Cleared" TextAlign="Center" Type="CheckBox" Width="60px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="ClearDate" Width="70px" />
                    <px:PXGridColumn DataField="Reconciled" TextAlign="Center" Type="CheckBox" Width="60px" />
                    <px:PXGridColumn DataField="DepositNbr" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="TranDesc" Width="200px" />
                    <px:PXGridColumn DataField="ReferenceID" Width="100px" />
                    <px:PXGridColumn DataField="BAccountR__AcctName" Width="200px" />
                    <px:PXGridColumn DataField="ReconNbr" Width="80px" LinkCommand="ViewRecon" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
