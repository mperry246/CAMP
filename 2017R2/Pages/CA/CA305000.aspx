...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Document" TypeName="PX.Objects.CA.CADepositEntry">
		<CallbackCommands>
			...
			<Levels>
				<px:PXGridLevel DataKeyNames="DocType,RefNbr" DataMember="AvailablePayments">
					<Columns>
						...
						<px:PXGridColumn DataField="Module" Width="64px"/>
						<px:PXGridColumn DataField="DocType" Width="80px" MatrixMode="True" />
						<px:PXGridColumn DataField="RefNbr" Width="90px" />
						<px:PXGridColumn DataField="BAccountID" Width="80px" />
						<px:PXGridColumn DataField="BAccountID_BAccountR_acctName" Width="140px" />
						<px:PXGridColumn DataField="LocationID" Width="80px" />
						<px:PXGridColumn DataField="ExtRefNbr" Width="120px" />
						<px:PXGridColumn AllowUpdate="False" DataField="DocDate" Width="90px" />
						<px:PXGridColumn AllowUpdate="False" DataField="DepositAfter" Width="90px" />
						<px:PXGridColumn DataField="CuryID" />
						<px:PXGridColumn AllowNull="False" DataField="CuryOrigDocAmt" TextAlign="Right" Width="90px" />
						...
						<px:PXGridColumn DataField="PMInstanceID" TextAlign="Left" DisplayMode="Text" Width="150"/>
						<px:PXGridColumn DataField="CuryChargeTotal" TextAlign="Right" Width="90px" />
						<px:PXGridColumn DataField="CuryGrossPaymentAmount" TextAlign="Right" Width="90px" />
					</Columns>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Document" Caption="Deposit Summary" NoteIndicator="True" FilesIndicator="True"
		...
		<Template>
			...
			<px:PXDropDown ID="edTranType" runat="server" AllowNull="False" DataField="TranType" />
			<px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" DataSourceID="ds" />
			<px:PXDropDown ID="edStatus" runat="server" DataField="Status" Enabled="False" AllowNull="False" />
					...
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" ActionsPosition="Top" BorderWidth="0px"
						...
						<Levels>
							<px:PXGridLevel DataMember="DepositPayments">
								...
								<Columns>
									<px:PXGridColumn DataField="OrigModule" Width="90px"/>
									<px:PXGridColumn DataField="PaymentInfo__DocType" MatrixMode="True" Width="108px"/>
									...
									<px:PXGridColumn DataField="PaymentInfo__BAccountID" Width="108px"/>
									<px:PXGridColumn DataField="PaymentInfo__BAccountID_Description" Width="160px" />
									...
									<px:PXGridColumn DataField="CuryTranAmt" AllowNull="False" TextAlign="Right" Width="100px" />
									<px:PXGridColumn AllowNull="False" DataField="CuryOrigAmt" TextAlign="Right" Width="100px" />
									...
									<px:PXGridColumn AllowUpdate="False" DataField="PaymentInfo__DocDate" Width="90px" />
									<px:PXGridColumn AllowUpdate="False" DataField="PaymentInfo__DepositAfter" Width="90px" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Charges">
								<RowTemplate>
									...
									<px:PXSelector ID="edEntryTypeID" runat="server" DataField="EntryTypeID" />
								...
								<Columns>
									<px:PXGridColumn DataField="EntryTypeID" Width="100px" AutoCallBack ="true" />
									<px:PXGridColumn DataField="PaymentMethodID" Width="100px" AutoCallBack ="true" />
									<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ChargeRate" TextAlign="Right" Width="108px" />
									<px:PXGridColumn DataField="CuryChargeableAmt" AllowNull="False" TextAlign="Right" Width="81px" />
									<px:PXGridColumn DataField="CuryChargeAmt" AllowNull="False" TextAlign="Right" Width="81px" />
