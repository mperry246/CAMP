...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="CAReconRecords" TypeName="PX.Objects.CA.CAReconEntry">
        <CallbackCommands>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100;" Width="100%" Caption="Reconciliation Details" SkinID="Details" TabIndex="2900" FilesIndicator="False" NoteIndicator="False">
        <Levels>
            <px:PXGridLevel DataMember="CAReconTranRecords">
                ...
                <Columns>
                    <px:PXGridColumn DataField="Reconciled" TextAlign="Center" Type="CheckBox" Width="60px" CommitChanges="True" />
                    <px:PXGridColumn DataField="Cleared" Width="60px" TextAlign="Center" Type="CheckBox" />
                    <px:PXGridColumn DataField="ClearDate" />
                    <px:PXGridColumn DataField="CuryEffDebitAmt" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="CuryEffCreditAmt" TextAlign="Right" Width="100px" />
                    ...
                    <px:PXGridColumn DataField="Status" Width="60px" AllowUpdate="False" Type="DropDownList" />
                    <px:PXGridColumn DataField="TranDate" />
                    <px:PXGridColumn DataField="ReferenceID" Width="100px" />
                    <px:PXGridColumn DataField="ReferenceID_description" Width="250px" />
