...
%>'>
                ...
                <Items>
                            ...
                            <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100"
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="DetailMatchesCA" DataKeyNames="TranID">
                                        ...
                                        <Columns>
                                            <px:PXGridColumn DataField="IsMatched" TextAlign="Center" Type="CheckBox" Width="72px" CommitChanges="True" AllowSort="False" />
                                            <px:PXGridColumn DataField="MatchRelevance" Width="70px" />
                                            <px:PXGridColumn DataField="OrigRefNbr" Width="70px" LinkCommand="ViewPayment" />
                                            <px:PXGridColumn DataField="TranDate" Width="70px" />
                                            <px:PXGridColumn DataField="ExtRefNbr" Width="100px" />
                                            <px:PXGridColumn DataField="OrigModule" Width="60px" />
                                            ...
                                            <px:PXGridColumn DataField="CuryTranAbsAmt" TextAlign="Right" Width="80px" />
                                            <px:PXGridColumn DataField="ReferenceID" Width="100px" />
                                            <px:PXGridColumn DataField="ReferenceID_description"  Width="220px" />
                                        </Columns>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="detailMatchingInvoices">
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="BranchID"  Width="64px" />
                                            <px:PXGridColumn DataField="OrigModule" Label="Module" Width="64px" />
                                            <px:PXGridColumn DataField="OrigTranType" Label="Tran. Type" RenderEditorText="True" Type="DropDownList" Width="80px" MatrixMode="true" />
                                            <px:PXGridColumn DataField="OrigRefNbr" Label="Tran. Type" RenderEditorText="True" LinkCommand="ViewInvoice" Width="90px" />
                                            <px:PXGridColumn DataField="ExtRefNbr" Label="Document Ref." Width="80px" />
                                            <px:PXGridColumn DataField="TranDate" Label="Doc. Date" Width="60px" />
                                            <px:PXGridColumn AllowNull="False" DataField="CuryTranAmt" Label="Amount" TextAlign="Right"
                                                Width="78px" />
                                            <px:PXGridColumn DataField="ReferenceID" Label="Business Account" Width="100px" />
                                            <px:PXGridColumn DataField="ReferenceName" Label="Account Name" Width="220px" />
                    ...
                    <px:PXTabItem Text="Create Payment" RepaintOnDemand="False" BindingContext="grid1">
                        <Template>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="Adjustments">
                                        ...
                                        <Columns>
											...
											<px:PXGridColumn DataField="ARInvoice__CustomerID" TextAlign="Right" Width="100px" />
                                ...
                                <Levels>
                                    <px:PXGridLevel DataKeyNames="BankTranID,BankTranType,LineNbr" DataMember="TranSplit">
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="CuryTranAmt" TextAlign="Right" Width="81px" CommitChanges="true" />
