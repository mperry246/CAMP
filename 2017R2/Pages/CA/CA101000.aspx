...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="669px" Width="100%" DataMember="CASetupRecord"
		...
		<Items>
			...
			<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="SM" StartColumn="True" StartGroup="True" />
			...
			<px:PXGrid ID="gridApproval" runat="server" Width="450px" Height="200px" TabIndex="11900" DataSourceID="ds" FeedbackMode="ForceDataEntry">
				<Levels>
					<px:PXGridLevel DataMember="Approval">
						...
						<Columns>
							<px:PXGridColumn DataField="AssignmentMapID" Width="200px" RenderEditorText="True" TextField="AssignmentMapID_EPAssignmentMap_Name" />
		...
		<px:PXTabItem Text="Bank Statement Settings">
			<Template>
				...
				<px:PXLayoutRule runat="server" LabelsWidth="XXS" ControlSize="M" StartGroup="True" GroupCaption="Auto-Matching Process"/>	
				<px:PXCheckBox ID="chkMatchInSelection" SuppressLabel="True" runat="server" DataField="MatchInSelection" />                
