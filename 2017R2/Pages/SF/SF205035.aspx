<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true"
     ValidateRequest="false" CodeFile="SF205035.aspx.cs" 
    Inherits="Page_SF205035" Title="Real-Time Sync" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.Salesforce.SFReSyncMaint" >
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
     ...
     <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
          ...
          AllowPaging="True" AdjustPageSize="Auto" NoteIndicator="False" FilesIndicator="False"
	 	  SkinID="Inquire" TabIndex="500" SyncPosition="True" MatrixMode="True" TemporaryFilterCaption="Filter Applied">
                        <Levels>
