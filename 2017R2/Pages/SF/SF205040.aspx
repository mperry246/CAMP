...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        SkinID="Inquire" TabIndex="500" SyncPosition="True" TemporaryFilterCaption="Filter Applied" AutoAdjustColumns="True" MatrixMode="True">
        <Levels>
            <px:PXGridLevel DataMember="Records">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="LocalID" Width="100px" DisplayMode="Text" TextAlign="Left" LinkCommand="ShowEntity" />
