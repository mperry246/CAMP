...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.ProformaEntry" PrimaryView="Document" BorderStyle="NotSet" PageLoadBehavior="GoLastRecord">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="RecalcAvalara" Visible="false" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Proforma Summary" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXNumberEdit ID="edDetailTotal" runat="server" DataField="CuryDetailTotal" Enabled="False" />
            <px:PXNumberEdit ID="edTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="False"  />
            ...
            <Levels>
                <px:PXGridLevel DataMember="Details">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="InvoicedAmount" TextAlign="Right" Width="90px" />                        
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <ActionBar>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="511px" DataSourceID="ds" DataMember="DocumentSettings">
        ...
        <Items >
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ProgressiveLines">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMRevenueBudget__RevisedAmount" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="PMRevenueBudget__ActualAmount" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="PMRevenueBudget__InvoicedAmount" TextAlign="Right" Width="90px" />
                                    <px:PXGridColumn DataField="PreviouslyInvoiced" TextAlign="Right" Width="90px" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="CuryRetainage" TextAlign="Right" Width="90px" />
            ...
            <px:PXTabItem Text="Billing Setings">
                <Template>
