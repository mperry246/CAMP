            ...
            <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AllowFilter="False" NoteIndicator="False" FilesIndicator="False" SyncPosition="True">
                <Levels>
                    <px:PXGridLevel DataMember="BillingRules">
                        <Columns>
                            <px:PXGridColumn DataField="IsActive" Width="30px" Type="CheckBox" />
                            <px:PXGridColumn DataField="StepID" SortDirection="Ascending" TextAlign="Right" Width="63px" CommitChanges="True" />
                            <px:PXGridColumn DataField="Description" Width="120px" CommitChanges="True" />
                            <px:PXGridColumn DataField="InvoiceGroup" Width="99px" CommitChanges="True" />
                        </Columns>
                    </px:PXGridLevel>
                </Levels>
        ...
        <Template2>
            <px:PXFormView ID="formRules" runat="server" DataSourceID="ds" DataMember="BillingRule" Width="100%">
                <Template>
                    ...
                    <px:PXSegmentMask ID="PXSegmentMask1" runat="server" DataField="AccountID" />
                    ...
                    <px:PXCheckBox ID="PXCheckBox4" runat="server" DataField="IncludeZeroQty" />
