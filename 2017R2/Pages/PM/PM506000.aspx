...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" AdjustPageSize="Auto" 
        AllowSearch="True" DataSourceID="ds" BatchUpdate="True" SkinID="PrimaryInquire" Caption="Documents" SyncPosition="True" FastFilterFields="CustomerID, CustomerID_BAccountR_acctName" TabIndex="300" TemporaryFilterCaption="Filter Applied">
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ProjectID" Width="110px" LinkCommand="viewDocumentProject">
                    </px:PXGridColumn>
                    <px:PXGridColumn AllowUpdate="False" DataField="RefNbr" Width="90px" LinkCommand="viewDocumentRef">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="CuryDocTotal" Width="120px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryID" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="DueDate" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="DiscDate" Width="210px">
                    </px:PXGridColumn>
                </Columns>
            </px:PXGridLevel>
        </Levels>
