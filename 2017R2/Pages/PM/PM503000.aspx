    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" Caption="Unbilled Invoices"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                ...
                <Columns>
                    <px:PXGridColumn AllowCheckAll="True" DataField="Selected" Label="Selected" TextAlign="Center" Type="CheckBox" Width="30px" />
                    <px:PXGridColumn DataField="ProjectCD" Label="Project" Width="108px" LinkCommand="viewDocumentProject"/>
