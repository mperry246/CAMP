                    ...
                    <px:PXGrid ID="gridRates" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" AllowSearch="True"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Rates" DataKeyNames="RateDefinitionID,LineNbr">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="StartDate" Label="StartDate" Width="108px" />
                                    <px:PXGridColumn DataField="EndDate" Label="EndDate" Width="108px" />
                                    <px:PXGridColumn DataField="Rate" Label="Rate" TextAlign="Right" Width="81px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Projects" DataKeyNames="RateDefinitionID,ProjectCD">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMProject__Description" Label="Description" Width="208px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
                    ...
                    <px:PXGrid ID="gridTasks" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" AllowSearch="True"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="RateDefinitionID,TaskCD">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="TaskCD" Label="Project Task" Width="108px" RenderEditorText="True" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="AccountGroups" DataKeyNames="RateDefinitionID,AccountGroupID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMAccountGroup__Description" Label="PMAccountGroup-Description" Width="500px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Items" DataKeyNames="RateDefinitionID,InventoryID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="InventoryItem__Descr" Label="InventoryItem-Description" Width="500px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Employees" DataKeyNames="RateDefinitionID,EmployeeID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BAccount__AcctName" Label="Employee-Employee Name" Width="208px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="200" />
