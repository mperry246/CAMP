			...
			<px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" AllowFilter="False" NoteIndicator="False" FilesIndicator="False" SyncPosition="True">
				<Levels>
					<px:PXGridLevel DataMember="Steps">
						<Columns>
							<px:PXGridColumn DataField="StepID" Label="Step ID" SortDirection="Ascending" TextAlign="Right" Width="63px" CommitChanges="True" />
							<px:PXGridColumn DataField="Description" Label="Description" Width="150px" CommitChanges="True"/>
						</Columns>
					</px:PXGridLevel>
				</Levels>
							...
							<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" DataMember="StepSettings" Width="100%" SkinID="Transparent">
								<Template>
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
                                        ...
                                        <px:PXLayoutRule ID="PXLayoutRule19" runat="server" StartRow="true" StartColumn="True" ColumnSpan="2" />
									...
									<px:PXPanel ID="PXPanel1" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXSegmentMask ID="PXSelector2" runat="server" DataField="TaskID" SuppressLabel="True" CommitChanges="True"/>
									...
									<px:PXPanel ID="PXPanel2" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXSegmentMask ID="PXSelector6" runat="server" DataField="OffsetTaskID" SuppressLabel="True" CommitChanges="True"/>
