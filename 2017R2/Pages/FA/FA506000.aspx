	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Details" Caption="Split Assets"
		...
		<Levels>
			<px:PXGridLevel DataMember="Splits">
				<Columns>
					<px:PXGridColumn AllowNull="False" DataField="Cost" TextAlign="Right" Width="100px" AutoCallBack="True" />
					<px:PXGridColumn AllowNull="False" DataField="SplittedQty" TextAlign="Right" Width="100px" AutoCallBack="True" />
					<px:PXGridColumn AllowNull="False" DataField="Ratio" TextAlign="Right" Width="100px" AutoCallBack="True" />
					<px:PXGridColumn DataField="SplittedAssetCD" Width="100px" LinkCommand="ViewAsset" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
