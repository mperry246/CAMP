...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" DefaultControlID="edPeriodID"
		...
		<Template>
			...
			<px:PXSelector CommitChanges="True" ID="edPeriodID" runat="server" DataField="PeriodID" Size="S"/>
			...
			<px:PXPanel ID="PXPanel1" runat="server" RenderSimple="True" RenderStyle="Simple">
				...
				<px:PXSegmentMask ID="edBranchFrom" runat="server" CommitChanges="True" DataField="BranchFrom" DataSourceID="ds" />
				...
				<px:PXSegmentMask ID="edBranchTo" runat="server" CommitChanges="True" DataField="BranchTo" DataSourceID="ds" />
		...
		<Levels>
			<px:PXGridLevel DataKeyNames="AssetCD" DataMember="Assets">
				<Columns>
					...
					<px:PXGridColumn AllowNull="False" DataField="FADetailsTransfer__CurrentCost" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="FADetailsTransfer__ReceiptDate" Width="90px" />
					<px:PXGridColumn DataField="UsefulLife" TextAlign="Right" Width="100px" />
					...
					<px:PXGridColumn DataField="FADetailsTransfer__TagNbr" Width="80px" />
