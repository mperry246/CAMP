...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" Caption="Books"
        AdjustPageSize="Auto" AllowPaging="True" FastFilterFields="BookCode, Description">
        <Levels>
            <px:PXGridLevel DataMember="Books">
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="FirstCalendarYear" TextAlign="Right" Width="81px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="LastCalendarYear" TextAlign="Right" Width="81px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
