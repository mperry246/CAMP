...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.FA.TransactionEntry" PrimaryView="Document">
        <CallbackCommands>
        ...
        <Levels>
            <px:PXGridLevel DataMember="Trans">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="AssetID_FixedAsset_description" Label="Description" AllowUpdate="False" Width="120px" />
                    ...
                    <px:PXGridColumn DataField="DebitAccountID" DisplayFormat="&gt;######" Width="60px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="DebitAccountID_Account_description" Width="120px" />
                    <px:PXGridColumn DataField="DebitSubID" DisplayFormat="&gt;AA-AA-AA-AA-AAA" Width="108px" />
                    <px:PXGridColumn DataField="DebitSubID_Sub_description" Width="120px" />
                    <px:PXGridColumn DataField="CreditAccountID" DisplayFormat="&gt;######" Width="60px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="CreditAccountID_Account_description" Width="120px" />
                    <px:PXGridColumn DataField="CreditSubID" DisplayFormat="&gt;AA-AA-AA-AA-AAA" Width="108px" />
