        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="AssetID" DataMember="Amts">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="DepreciateFromDate" Width="108px" />
                    <px:PXGridColumn DataField="BranchID" />
                    <px:PXGridColumn DataField="Department" />
                    <px:PXGridColumn AllowNull="False" DataField="ItdAmt" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowNull="False" DataField="YtdAmt" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowNull="False" DataField="PtdAmt" TextAlign="Right" Width="100px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
