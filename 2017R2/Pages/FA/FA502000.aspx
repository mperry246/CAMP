...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" DefaultControlID="edPeriodID"
		...
		<Template>
			...
			<px:PXSelector CommitChanges="True" runat="server" InputMask="##-####" DataField="PeriodID" ID="edPeriodID" Size="S" />
		...
		<Levels>
			<px:PXGridLevel DataMember="Balances">
				<Columns>
					...
					<px:PXGridColumn DataField="FixedAsset__Description" Width="200px" />
					...
					<px:PXGridColumn AllowNull="False" DataField="YtdDeprBase" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="FADetails__ReceiptDate" Width="90px" />
					<px:PXGridColumn DataField="FixedAsset__UsefulLife" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="FixedAsset__FAAccountID" />
					<px:PXGridColumn DataField="FixedAsset__FASubID" />
					<px:PXGridColumn DataField="FADetails__TagNbr" Width="80px" />
