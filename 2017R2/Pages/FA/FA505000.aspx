...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            ...
            <px:PXSelector ID="edDisposalPeriodID" runat="server" DataField="DisposalPeriodID"  CommitChanges="True" AutoCallBack="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Caption="Assets to Dispose"
        ...
        FastFilterFields="AssetCD, Description">
        <Levels>
            <px:PXGridLevel DataKeyNames="AssetCD" DataMember="Assets">
                <Columns>
                    <px:PXGridColumn AllowCheckAll="True" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="30px" AutoCallBack="True" />
                    ...
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="FADetails__CurrentCost" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="DisposalAmt" TextAlign="Right" Width="100px" AutoCallBack="True" />
                    <px:PXGridColumn DataField="FADetails__ReceiptDate" Width="90px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="UsefulLife" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="FAAccountID" />
                    <px:PXGridColumn AllowUpdate="False" DataField="FASubID" Width="120px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="FADetails__TagNbr" Width="80px" />
                    <px:PXGridColumn DataField="Account__AccountClassID" Width="80px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
