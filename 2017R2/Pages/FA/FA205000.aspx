    ...
    <px:PXGrid ID="grid" runat="server" Width="100%" Style="z-index: 100; left: 0px; top: 0px; height: 286px;" AllowPaging="True"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Book">
                ...
                <Columns>
                    <px:PXGridColumn DataField="BookCode" Width="63px" DisplayFormat="&gt;CCCCCCCCCC" />
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="FirstCalendarYear" Label="Last Calendar Year" Width="81px" TextAlign="Right" />
                    <px:PXGridColumn AllowUpdate="False" DataField="LastCalendarYear" Label="Last Calendar Year" Width="81px" TextAlign="Right" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
