                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="AssetBalance" DataKeyNames="AssetID,BookID">
                                ...
                                <Columns>
									...
									<px:PXGridColumn DataField="DeprFromDate" AutoCallBack="True" Width="81px" />
									...
									<px:PXGridColumn DataField="AveragingConvention" RenderEditorText="True" Label="Averaging Convention" Width="75px" MatrixMode="True"/>
									...
									<px:PXGridColumn DataField="BonusID" Width="81px" CommitChanges="True" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="LocationHistory">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="EmployeeID" Width="80px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="EmployeeID_EPEmployee_acctName" Label="Employee Name" Width="120px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="DsplAdditions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="FAAccrualTran__BranchID" DisplayFormat="&gt;AAAAAAAAAA" Label="Transaction Branch" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="FAAccrualTran__InventoryID" DisplayFormat="&gt;AAAAAAAAAAAA" Label="Inventory ID" />
                                    <px:PXGridColumn DataField="FAAccrualTran__UOM" DisplayFormat="&gt;aaaaaa" Label="UOM" />
